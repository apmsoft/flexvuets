...
class ComponentActivity
{
    ...
    doPost(){
        ...
        .then(Module => 
        {
            ...
            document.querySelector<HTMLDivElement>('#left_docs_contents')!.innerHTML = postView.render({});
    ...
    doEdit(params : { id?: number } = {})
    {
        ...
        Promise.all([
            ...
            document.querySelector<HTMLDivElement>('#left_docs_contents')!.innerHTML = editView.render(resp);
            return resp;
        })
        .then(resp=>
        {
