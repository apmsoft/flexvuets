...
const onReady = () : void =>
{
    ...
    // example 2
    const sliderPips = document.querySelector<HTMLDivElement>('#slider-pips')!;
    ...
    // example 3
    const stepsSlider = document.querySelector<HTMLDivElement>('#steps-slider')!;
    const input0 = document.querySelector<HTMLInputElement>('#input-with-keypress-0')!;
    const input1 = document.querySelector<HTMLInputElement>('#input-with-keypress-1')!;
