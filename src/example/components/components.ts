...
const onReady = () : void =>
{
    ...
    new ElementDiv('#fvue--layout--main').html(
        new CreateElDiv().id('#layout').classList('container mx-auto card flex flex-col p-4 my-4 space-y-4').render('')
    );

    new ElementDiv('#layout').insert('append').html(
