...
import {ElementDiv, ElementTextArea,ElementInput, ElementButton, ElementSelect, ElementRadio,ElementCheckbox,ElementUL,ElementLi} from '@flexvue/elementshtml';
import {Template} from '@flexvue/types';
const onReady = () : void =>
{

    class RadioView implements Template
    {
        // interface
    ...
    console.log(
        '이미선택된 값 가져오기',
        new ElementSelect('#category').val()
    );
