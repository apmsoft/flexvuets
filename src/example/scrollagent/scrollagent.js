...
var scrollagent_class_js_1 = require("@flexvue/core/scrollagent.class.js");
var onReady = function () {
    var _a, _b, _c, _d, _e, _f, _g, _h;
    // 채널 등록
    new ScrollObserver(['notice', 'category', 'qna']);
    // vertical
    var noticeScrollAgent = new scrollagent_class_js_1.default('notice');
    var noticePreTopPos = noticeScrollAgent.getPos();
    ...
    // horizontal -
    var horizontalScrollAgent = new scrollagent_class_js_1.default('category');
    var horizontalPreLeftPos = horizontalScrollAgent.getPos();
