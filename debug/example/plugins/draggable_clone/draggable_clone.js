...
const onReady = () => {
  ...
  function dragStart(e) {
    ...
    clonedNode === null || clonedNode === void 0 ? void 0 : clonedNode.classList.add("draggable-clone");
  ...
  function dragDropped(e) {
    ...
    if (initialDropzone === dropzone) clonedNode.style.display = "none";else clonedNode.style.display = "inherit";
