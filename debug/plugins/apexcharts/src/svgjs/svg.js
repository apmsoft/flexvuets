  ...
  SVG.Situation = SVG.invent({
    ...
    create: function (o) {
      ...
      this.animations = {
        ...
        * @return target || this
        */animate: function (o, ease, delay) {if (typeof o === 'object') {ease = o.ease;delay = o.delay;o = o.duration;}var situation = new SVG.Situation({ duration: o || 1000, delay: delay || 0, ease: SVG.easing[ease || '-'] || ease });this.queue(situation);
          return this;
        },
  ...
  SVG.BBox = SVG.invent({
    ...
    construct: { // Get bounding box
      ...
      create: function (source) {var base = arrayToMatrix([1, 0, 0, 1, 0, 0]); // ensure source as object
        source = source === null ? base : source instanceof SVG.Element ? source.matrixify() : typeof source === 'string' ? arrayToMatrix(source.split(SVG.regex.delimiter).map(parseFloat)) : arguments.length == 6 ? arrayToMatrix([].slice.call(arguments)) :
