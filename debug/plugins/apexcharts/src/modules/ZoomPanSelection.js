...
export default class ZoomPanSelection extends Toolbar {
  constructor(ctx) {
    ...
    this.eventList = ['mousedown', 'mouseleave', 'mousemove', 'touchstart', 'touchmove', 'mouseup', 'touchend'];
    this.clientX = 0;
    this.clientY = 0;
    this.startX = 0;
    this.endX = 0;
  ...
  svgMouseEvents(xyRatios, e) {
    ...
    const falsePositives = tc.contains('apexcharts-selection-rect') || tc.contains('apexcharts-legend-marker') || tc.contains('apexcharts-legend-text') || pc && pc.contains('apexcharts-toolbar');
