import { a as getWindow, g as getDocument } from "./ssr-window.esm.min.mjs";
...
function calcDevice(e) {
  ...
  const p = n.match(/(iPod)(.*OS\s([\d_]+))?/),
    ...
    h = "Win32" === r;
  let m = "MacIntel" === r;
  return !c && m && s.touch && ["1024x1366", "1366x1024", "834x1194", "1194x834", "834x1112", "1112x834", "768x1024", "1024x768", "820x1180", "1180x820", "810x1080", "1080x810"].indexOf(`${l}x${o}`) >= 0 && (c = n.match(/(Version)\/([\d.]+)/), c || (c = [0, 1, "13_0_0"]), m = !1), d && !h && (a.os = "android", a.android = !0), (c || u || p) && (a.os = "ios", a.ios = !0), a;
}
...
function updateSlides() {
  ...
  const s = e.params,
    ...
    c = elementChildren(r, `.${e.params.slideClass}, swiper-slide`),
  ...
  }), s.centeredSlides && s.cssMode && (setCSSProperty(i, "--swiper-centered-offset-before", ""), setCSSProperty(i, "--swiper-centered-offset-after", ""));
  ...
  for (let i = 0; i < p; i += 1) {
    let r;
    if (E = 0, c[i] && (r = c[i]), y && e.grid.updateSlide(i, r, c), !c[i] || "none" !== elementStyle(r, "display")) {
      if ("auto" === s.slidesPerView) {
        C && (c[i].style[e.getDirectionLabel("width")] = "");
        const n = getComputedStyle(r),
          a = r.style.transform,
          l = r.style.webkitTransform;
        if (a && (r.style.transform = "none"), l && (r.style.webkitTransform = "none"), s.roundLengths) E = e.isHorizontal() ? elementOuterSize(r, "width", !0) : elementOuterSize(r, "height", !0);else {
          const e = t(n, "width"),
            s = t(n, "padding-left"),
            i = t(n, "padding-right"),
            a = t(n, "margin-left"),
          ...
          if (o && "border-box" === o) E = e + a + l;else {
            const {
              clientWidth: t,
              offsetWidth: n
            } = r;
  ...
  if (Object.assign(e, {
    ...
    setCSSProperty(i, "--swiper-centered-offset-before", -u[0] + "px"), setCSSProperty(i, "--swiper-centered-offset-after", e.size / 2 - m[m.length - 1] / 2 + "px");
...
function updateSlidesProgress(e) {
  ...
  for (let e = 0; e < i.length; e += 1) {
    ...
    (u >= 0 && u < t.size - 1 || h > 1 && h <= t.size || u <= 0 && h >= t.size) && (t.visibleSlides.push(o), t.visibleSlidesIndexes.push(e), i[e].classList.add(s.slideVisibleClass)), m && i[e].classList.add(s.slideFullyVisibleClass), o.progress = r ? -c : c, o.originalProgress = r ? -p : p;
  }
}
...
function updateSlidesClasses() {
  const e = this,
    ...
    l = e => elementChildren(i, `.${s.slideClass}${e}, swiper-slide${e}`)[0];
  let o, d, c;
  if (t.forEach(e => {
  ...
  o && (o.classList.add(s.slideActiveClass), a ? (c && c.classList.add(s.slideNextClass), d && d.classList.add(s.slidePrevClass)) : (c = elementNextAll(o, `.${s.slideClass}, swiper-slide`)[0], s.loop && !c && (c = t[0]), c && c.classList.add(s.slideNextClass), d = elementPrevAll(o, `.${s.slideClass}, swiper-slide`)[0], s.loop && 0 === !d && (d = t[t.length - 1]), d && d.classList.add(s.slidePrevClass))), e.emitSlidesClasses();
}
...
function slideTo(e, t, s, i, r) {
  ...
  if (n.animating && l.preventInteractionOnTransition || !m && !i && !r || n.destroyed) return !1;
...
function slideToClickedSlide() {
  ...
  if (t.loop) {
    ...
    r = parseInt(e.clickedSlide.getAttribute("data-swiper-slide-index"), 10), t.centeredSlides ? n < e.loopedSlides - i / 2 || n > e.slides.length - e.loopedSlides + i / 2 ? (e.loopFix(), n = e.getSlideIndex(elementChildren(s, `${a}[data-swiper-slide-index="${r}"]`)[0]), nextTick(() => {
      e.slideTo(n);
    })) : e.slideTo(n) : n > e.slides.length - i ? (e.loopFix(), n = e.getSlideIndex(elementChildren(s, `${a}[data-swiper-slide-index="${r}"]`)[0]), nextTick(() => {
      e.slideTo(n);
    })) : e.slideTo(n);
  } else e.slideTo(n);
}
...
function loopCreate(e) {
  ...
  const r = () => {
      elementChildren(i, `.${s.slideClass}, swiper-slide`).forEach((e, t) => {
    ...
    d = e => {
      for (let i = 0; i < e; i += 1) {
        const e = t.isElement ? createElement("swiper-slide", [s.slideBlankClass]) : createElement("div", [s.slideClass, s.slideBlankClass]);
        t.slidesEl.append(e);
      }
    };
  if (l) {
...
function loopFix(e) {
  ...
  d.length < f + g ? showWarning("Swiper Loop Warning: The number of slides is not enough for loop mode, it will be disabled and not function properly. You need to add more slides (or make duplicates) or lower the values of slidesPerView and slidesPerGroup parameters") : w && "row" === h.grid.fill && showWarning("Swiper Loop Warning: Loop mode is not compatible with grid.fill = `row`");
  const S = [],
    T = [];
  let b = o.activeIndex;
  ...
  const M = w ? Math.ceil(d.length / h.grid.rows) : d.length,
    P = (w ? d[n].column : n) + (m && void 0 === r ? -f / 2 + .5 : 0);
  if (P < g) {
    E = Math.max(g - P, v);
  ...
  }), h.watchSlidesProgress && o.updateSlidesOffset(), s) if (S.length > 0 && y) {
    if (void 0 === t) {
  ...
  } else if (T.length > 0 && x) if (void 0 === t) {
    const e = o.slidesGrid[b],
...
function onTouchStart(e) {
  ...
  Object.assign(r, {
    ...
    isScrolling: void 0,
    startMoving: void 0
  }), a.startX = h, a.startY = m, r.touchStartTime = now(), t.allowClick = !0, t.updateSize(), t.swipeDirection = void 0, n.threshold > 0 && (r.allowThresholdMove = !1);
  let f = !0;
...
function onTouchMove(e) {
  ...
  if (i.isScrolling && s.emit("touchMoveOpposite", d), void 0 === i.startMoving && (n.currentX === n.startX && n.currentY === n.startY || (i.startMoving = !0)), i.isScrolling) return void (i.isTouched = !1);
...
function setBreakpoint() {
  ...
  }), c && !m ? e.disable() : !c && m && e.enable(), e.currentBreakpoint = a, e.emit("_beforeBreakpoint", l), s && (u ? (e.loopDestroy(), e.loopCreate(t), e.updateSlides()) : !h && f ? (e.loopCreate(t), e.updateSlides()) : h && !f && e.loopDestroy()), e.emit("breakpoint", l);
}
...
function addClasses() {
  const e = this,
    ...
    a = prepareClasses(["initialized", s.direction, {
...
class Swiper {
  constructor() {
    ...
    1 === i.length && i[0].constructor && "Object" === Object.prototype.toString.call(i[0]).slice(8, -1) ? t = i[0] : [e, t] = i, t || (t = {}), t = extend({}, t), e && !t.el && (t.el = e);
    const n = getDocument();
    ...
    }), a.browser = getBrowser(), a.eventsListeners = {}, a.eventsAnyListeners = [], a.modules = [...a.__modules__], t.modules && Array.isArray(t.modules) && a.modules.push(...t.modules);
    const l = {};
    a.modules.forEach(e => {
      e({
        params: t,
    ...
    return a.params = extend({}, o, extendedDefaults, t), a.originalParams = extend({}, a.params), a.passedParams = extend({}, t), a.params && a.params.on && Object.keys(a.params.on).forEach(e => {
  ...
  getSlideIndex(e) {
    const {
      ...
      i = elementChildren(t, `.${s.slideClass}, swiper-slide`),
      r = elementIndex(i[0]);
  ...
  mount(e) {
    ...
    return !r && t.params.createElements && (r = createElement("div", t.params.wrapperClass), s.append(r), elementChildren(s, `.${t.params.slideClass}`).forEach(e => {
      r.append(e);
    })), Object.assign(t, {
      el: s,
      wrapperEl: r,
      ...
      wrongRTL: "-webkit-box" === elementStyle(r, "display")
    }), !0;
  }
  init(e) {
    const t = this;
