...
import { p as paramsList, n as needsNavigation, a as needsPagination, b as needsScrollbar, u as updateSwiper, c as attrToProp } from "./shared/update-swiper.min.mjs";
...
const ClassToExtend = "undefined" == typeof window || "undefined" == typeof HTMLElement ? DummyHTMLElement : HTMLElement,
  ...
  addStyle = (e, s) => {
    if ("undefined" != typeof CSSStyleSheet && e.adoptedStyleSheets) {
      ...
      t.replaceSync(s), e.adoptedStyleSheets = [t];
    } else {
      const t = document.createElement("style");
      t.rel = "stylesheet", t.textContent = s, e.appendChild(t);
    }
  };
class SwiperContainer extends ClassToExtend {
  ...
  calcSlideSlots() {
    const e = this.slideSlots || 0,
      s = [...this.querySelectorAll("[slot^=slide-]")].map(e => parseInt(e.getAttribute("slot").split("slide-")[1], 10));
    if (this.slideSlots = s.length ? Math.max(...s) + 1 : 0, this.rendered) if (this.slideSlots > e) for (let s = e; s < this.slideSlots; s += 1) {
      ...
      for (let s = e.length - 1; s >= 0; s -= 1) s > this.slideSlots && e[s].remove();
    }
  }
  render() {
    ...
    this.slideSlots > 0 && (e = e.replace(/::slotted\(([a-z-0-9.]*)\)/g, "$1")), e.length && addStyle(this.shadowRoot, e), this.cssLinks().forEach(e => {
      if (this.shadowRoot.querySelector(`link[href="${e}"]`)) return;
      const s = document.createElement("link");
      s.rel = "stylesheet", s.href = e, this.shadowRoot.appendChild(s);
    });
    const s = document.createElement("div");
    s.classList.add("swiper"), s.part = "container", s.innerHTML = `\n      <slot name="container-start"></slot>\n      <div class="swiper-wrapper" part="wrapper">\n        <slot></slot>\n        ${Array.from({
  ...
  initialize() {
    ...
    this.swiperParams = s, this.passedParams = t, delete this.swiperParams.init, this.render(), this.swiper = new Swiper(this.shadowRoot.querySelector(".swiper"), {
      ...(s.virtual ? {} : {
        observer: !0,
      ...
      onAny: function (t) {
        ...
        const i = s.eventsPrefix ? `${s.eventsPrefix}${t.toLowerCase()}` : t.toLowerCase();
  ...
  updateSwiperOnPropChange(e, s) {
    ...
    this.passedParams = i, this.swiperParams = t, this.swiper && this.swiper.params[e] === s || updateSwiper({
      swiper: this.swiper,
  ...
  attributeChangedCallback(e, s, t) {
    this.initialized && ("true" === s && null === t && (t = !1), this.updateSwiperOnPropChange(e, t));
  }
  static get observedAttributes() {
    return paramsList.filter(e => e.includes("_")).map(e => e.replace(/[A-Z]/g, e => `-${e}`).replace("_", "").toLowerCase());
  }
}
paramsList.forEach(e => {
  "init" !== e && (e = e.replace("_", ""), Object.defineProperty(SwiperContainer.prototype, e, {
    configurable: !0,
    get() {
      return (this.passedParams || {})[e];
    },
    set(s) {
      this.passedParams || (this.passedParams = {}), this.passedParams[e] = s, this.initialized && this.updateSwiperOnPropChange(e, s);
    }
  }));
});
...
const register = () => {
  "undefined" != typeof window && (window.customElements.get("swiper-container") || window.customElements.define("swiper-container", SwiperContainer), window.customElements.get("swiper-slide") || window.customElements.define("swiper-slide", SwiperSlide));
};
