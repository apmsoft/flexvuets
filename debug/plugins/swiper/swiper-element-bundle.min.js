...
class SwiperContainer extends ClassToExtend {
  ...
  calcSlideSlots() {
    const e = this.slideSlots || 0,
      i = [...this.querySelectorAll("[slot^=slide-]")].map(e => parseInt(e.getAttribute("slot").split("slide-")[1], 10));
    if (this.slideSlots = i.length ? Math.max(...i) + 1 : 0, this.rendered) if (this.slideSlots > e) for (let i = e; i < this.slideSlots; i += 1) {
      const e = document.createElement("swiper-slide");
      e.setAttribute("part", `slide slide-${i + 1}`);
      const t = document.createElement("slot");
      t.setAttribute("name", `slide-${i + 1}`), e.appendChild(t), this.shadowRoot.querySelector(".swiper-wrapper").appendChild(e);
    } else if (this.slideSlots < e) {
      const e = this.swiper.slides;
      for (let i = e.length - 1; i >= 0; i -= 1) i > this.slideSlots && e[i].remove();
    }
  }
  render() {
  ...
  initialize() {
    ...
    this.swiperParams = i, this.passedParams = t, delete this.swiperParams.init, this.render(), this.swiper = new Swiper(this.shadowRoot.querySelector(".swiper"), {
      ...(i.virtual ? {} : {
        observer: !0,
      ...
      onAny: function (t) {
        ...
        const s = i.eventsPrefix ? `${i.eventsPrefix}${t.toLowerCase()}` : t.toLowerCase();
  ...
  updateSwiperOnPropChange(e, i) {
    ...
    this.passedParams = s, this.swiperParams = t, this.swiper && this.swiper.params[e] === i || updateSwiper({
      swiper: this.swiper,
  ...
  attributeChangedCallback(e, i, t) {
    this.initialized && ("true" === i && null === t && (t = !1), this.updateSwiperOnPropChange(e, t));
  }
...
paramsList.forEach(e => {
  "init" !== e && (e = e.replace("_", ""), Object.defineProperty(SwiperContainer.prototype, e, {
    ...
    set(i) {
      this.passedParams || (this.passedParams = {}), this.passedParams[e] = i, this.initialized && this.updateSwiperOnPropChange(e, i);
    }
  }));
});
