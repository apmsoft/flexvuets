...
function EffectFlip(e) {
  ...
  const a = (e, s) => {
    ...
    r || (r = createShadow("flip", e, t.isHorizontal() ? "left" : "top")), a || (a = createShadow("flip", e, t.isHorizontal() ? "right" : "bottom")), r && (r.style.opacity = Math.max(-s, 0)), a && (a.style.opacity = Math.max(s, 0));
  };
  effectInit({
    effect: "flip",
    swiper: t,
    ...
    setTranslate: () => {
      ...
      for (let i = 0; i < e.length; i += 1) {
        ...
        let n = -180 * l,
          d = 0,
          p = t.params.cssMode ? -f - t.translate : -f,
          m = 0;
        ...
        effectTarget(r, o).style.transform = c;
      }
    },
    setTransition: e => {
