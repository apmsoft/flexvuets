...
function Navigation(a) {
  ...
  function s(a) {
    let n;
    return a && "string" == typeof a && e.isElement && (n = e.el.querySelector(a), n) ? n : (a && ("string" == typeof a && (n = [...document.querySelectorAll(a)]), e.params.uniqueNavElements && "string" == typeof a && n.length > 1 && 1 === e.el.querySelectorAll(a).length && (n = e.el.querySelector(a))), a && !n ? a : n);
  }
  function l(a, n) {
    const i = e.params.navigation;
    (a = makeElementsArray(a)).forEach(a => {
  ...
  function c() {
    ...
    a = makeElementsArray(a), n = makeElementsArray(n);
    const i = (a, n) => {
  ...
  n({
    ...
    a = makeElementsArray(a), n = makeElementsArray(n), e.enabled ? r() : [...a, ...n].filter(a => !!a).forEach(a => a.classList.add(e.params.navigation.lockClass));
  }), i("click", (a, n) => {
    let {
      nextEl: i,
      prevEl: s
    } = e.navigation;
    i = makeElementsArray(i), s = makeElementsArray(s);
    const l = n.target;
    if (e.params.navigation.hideOnClick && !s.includes(l) && !i.includes(l)) {
      ...
      let a;
      i.length ? a = i[0].classList.contains(e.params.navigation.hiddenClass) : s.length && (a = s[0].classList.contains(e.params.navigation.hiddenClass)), t(!0 === a ? "navigationShow" : "navigationHide"), [...i, ...s].filter(a => !!a).forEach(a => a.classList.toggle(e.params.navigation.hiddenClass));
    }
  });
  const p = () => {
