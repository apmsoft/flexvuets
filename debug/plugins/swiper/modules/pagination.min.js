...
function Pagination(e) {
  ...
  function c(e) {
    const s = e.target.closest(classesToSelector(a.params.pagination.bulletClass));
    if (!s) return;
    e.preventDefault();
    const l = elementIndex(s) * a.params.slidesPerGroup;
    if (a.params.loop) {
  ...
  function d() {
    ...
    let l,
      i,
      c = a.pagination.el;
    c = makeElementsArray(c);
    const d = a.virtual && a.params.virtual.enabled ? a.virtual.slides.length : a.slides.length,
    ...
    if (a.params.loop ? (i = a.previousRealIndex || 0, l = a.params.slidesPerGroup > 1 ? Math.floor(a.realIndex / a.params.slidesPerGroup) : a.realIndex) : void 0 !== a.snapIndex ? (l = a.snapIndex, i = a.previousSnapIndex) : (i = a.previousIndex || 0, l = a.activeIndex || 0), "bullets" === s.type && a.pagination.bullets && a.pagination.bullets.length > 0) {
      ...
      let o, d, m;
      if (s.dynamicBullets && (n = elementOuterSize(t[0], a.isHorizontal() ? "width" : "height", !0), c.forEach(e => {
      ...
      if (s.dynamicBullets) {
        const l = Math.min(t.length, s.dynamicMainBullets + 4),
          i = (n * l - n) / 2 - m * n,
          r = e ? "right" : "left";
        t.forEach(e => {
    ...
    c.forEach((e, i) => {
      if ("fraction" === s.type && (e.querySelectorAll(classesToSelector(s.currentClass)).forEach(e => {
        ...
        let n = 1,
          r = 1;
        "horizontal" === t ? n = i : r = i, e.querySelectorAll(classesToSelector(s.progressbarFillClass)).forEach(e => {
  ...
  function m() {
    ...
    "fraction" === e.type && (i = e.renderFraction ? e.renderFraction.call(a, e.currentClass, e.totalClass) : `<span class="${e.currentClass}"></span> / <span class="${e.totalClass}"></span>`), "progressbar" === e.type && (i = e.renderProgressbar ? e.renderProgressbar.call(a, e.progressbarFillClass) : `<span class="${e.progressbarFillClass}"></span>`), a.pagination.bullets = [], l.forEach(s => {
      "custom" !== e.type && (s.innerHTML = i || ""), "bullets" === e.type && a.pagination.bullets.push(...s.querySelectorAll(classesToSelector(e.bulletClass)));
    }), "custom" !== e.type && t("paginationRender", l[0]);
  }
  function u() {
    a.params.pagination = createElementIfNotDefined(a, a.originalParams.pagination, a.params.pagination, {
    ...
    "string" == typeof e.el && a.isElement && (s = a.el.querySelector(e.el)), s || "string" != typeof e.el || (s = [...document.querySelectorAll(e.el)]), s || (s = e.el), s && 0 !== s.length && (a.params.uniqueNavElements && "string" == typeof e.el && Array.isArray(s) && s.length > 1 && (s = [...a.el.querySelectorAll(e.el)], s.length > 1 && (s = s.filter(e => elementParents(e, ".swiper")[0] === a.el)[0])), Array.isArray(s) && 1 === s.length && (s = s[0]), Object.assign(a.pagination, {
      el: s
    }), s = makeElementsArray(s), s.forEach(s => {
  ...
  function g() {
    ...
    s && (s = makeElementsArray(s), s.forEach(s => {
  ...
  l("changeDirection", () => {
    ...
    e && (e = makeElementsArray(e), e.forEach(e => e.classList[a.enabled ? "remove" : "add"](a.params.pagination.lockClass)));
  }), l("lock unlock", () => {
    d();
  }), l("click", (e, s) => {
    const l = s.target,
      i = makeElementsArray(a.pagination.el);
  ...
  const b = () => {
    ...
    e && (e = makeElementsArray(e), e.forEach(e => e.classList.add(a.params.pagination.paginationDisabledClass))), g();
  };
  Object.assign(a.pagination, {
    enable: () => {
      ...
      e && (e = makeElementsArray(e), e.forEach(e => e.classList.remove(a.params.pagination.paginationDisabledClass))), u(), m(), d();
    },
    disable: b,
    render: m,
    update: d,
