import { g as getDocument, a as getWindow } from "../shared/ssr-window.esm.min.mjs";
  ...
  t({
    hashNavigation: {
      ...
      getSlideIndex(a, t) {
        ...
        return e.getSlideIndex(elementChildren(e.slidesEl, `.${e.params.slideClass}[data-hash="${t}"], swiper-slide[data-hash="${t}"]`)[0]);
      }
    }
  });
  const d = () => {
