...
function Parallax(a) {
  ...
  const r = "[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y], [data-swiper-parallax-opacity], [data-swiper-parallax-scale]",
    s = (a, t) => {
      ...
      let i = a.getAttribute("data-swiper-parallax-x"),
        p = a.getAttribute("data-swiper-parallax-y");
      const n = a.getAttribute("data-swiper-parallax-scale"),
        o = a.getAttribute("data-swiper-parallax-opacity"),
        d = a.getAttribute("data-swiper-parallax-rotate");
    ...
    i = () => {
      const {
        ...
        n = elementChildren(a, r);
      e.isElement && n.push(...elementChildren(e.hostEl, r)), n.forEach(a => {
        s(a, l);
      }), t.forEach((a, t) => {
        let p = a.progress;
