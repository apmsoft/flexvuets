...
const classes = {
  ...
  DOMDefault = e => `<div class="${e.header}"><#ArrowPrev /><div class="${e.headerContent}"><#Month /><#Year /></div><#ArrowNext /></div><div class="${e.wrapper}"><#WeekNumbers /><div class="${e.content}"><#Week /><#Days /></div></div><#ControlTime />`,
  DOMMultiple = e => `<div class="${e.controls}"><#ArrowPrev /><#ArrowNext /></div><div class="${e.grid}"><#Multiple><div class="${e.column}"><div class="${e.header}"><div class="${e.headerContent}"><#Month /><#Year /></div></div><div class="${e.wrapper}"><#WeekNumbers /><div class="${e.content}"><#Week /><#Days /></div></div></div><#/Multiple></div><#ControlTime />`,
  DOMMonths = e => `<div class="${e.header}"><div class="${e.headerContent}"><#Month /><#Year /></div></div><div class="${e.wrapper}"><div class="${e.content}"><#Months /></div></div>`,
  DOMYears = e => `<div class="${e.header}"><#ArrowPrev /><div class="${e.headerContent}"><#Month /><#Year /></div><#ArrowNext /></div><div class="${e.wrapper}"><div class="${e.content}"><#Years /></div></div>`;
class DefaultOptionsCalendar {
  constructor() {
    var e;
    __publicField(this, "isInit", !1), __publicField(this, "input", !1), __publicField(this, "type", "default"), __publicField(this, "months", 2), __publicField(this, "jumpMonths", 1), __publicField(this, "date", {
      min: "1970-01-01",
      max: "2470-12-31",
      today: new Date()
      ...
      showCalendar: null,
      hideCalendar: null
    }), __publicField(this, "popups", {}), __publicField(this, "CSSClasses", __spreadValues({}, classes)), __publicField(this, "DOMTemplates", {
...
const getDateString = e => `${e.getFullYear()}-${String(e.getMonth() + 1).padStart(2, "0")}-${String(e.getDate()).padStart(2, "0")}`,
  ...
  parseDates = e => e.reduce((e, t) => (t.match(/^(\d{4}-\d{2}-\d{2})$/g) ? e.push(t) : t.replace(/(\d{4}-\d{2}-\d{2}).*?(\d{4}-\d{2}-\d{2})/g, (t, a, n) => {
    const s = getDate(a),
      l = getDate(n),
  ...
  visibilityArrows = e => {
    ...
    ({
      default: () => {
        const t = getDate(getDateString(new Date(e.selectedYear, e.selectedMonth, 1))),
  ...
  createWeekNumber = (e, t, a, n, s) => {
    const l = t[a].querySelector(`.${e.CSSClasses.dayBtn}`),
      r = getWeekNumber(null == l ? void 0 : l.dataset.calendarDay, e.settings.iso8601);
    if (!r) return;
  ...
  setDisabledDays = (e, t, a) => {
    ...
    const d = null == (n = e.settings.range.disableWeekday) ? void 0 : n.includes(a),
      c = e.settings.range.disableAllDays && !!(null == (s = e.rangeEnabled) ? void 0 : s[0]);
    !d && !c || (null == (l = e.rangeEnabled) ? void 0 : l.includes(t)) || (null == (r = e.rangeDisabled) ? void 0 : r.includes(t)) || (e.rangeDisabled.push(t), null == (i = e.rangeDisabled) || i.sort((e, t) => +new Date(e) - +new Date(t)));
  },
  ...
  createDays = e => {
    ...
    t.forEach((t, s) => {
      ...
      const r = l.getMonth(),
        i = l.getFullYear(),
        d = new Date(i, r, 1),
        c = new Date(i, r + 1, 0).getDate(),
        o = e.settings.iso8601 ? (0 !== d.getDay() ? d.getDay() : 7) - 1 : d.getDay();
      e.settings.selection.day && t.classList.add(e.CSSClasses.daysSelecting), t.innerHTML = "", prevMonth(e, t, i, r, o), currentMonth(e, t, c, i, r), nextMonth(e, t, c, i, r, o), createWeekNumbers(e, o, c, a[s], t), createPopup(e, t);
    });
  },
  ...
  changeMonth = (e, t) => {
    ...
    })[t](), [e.selectedMonth, e.selectedYear] = [a.getMonth(), a.getFullYear()], visibilityTitle(e), visibilityArrows(e), createDays(e);
  },
  ...
  MultipleParser = (e, t) => t.replace(/<#Multiple>(.*?)<#\/Multiple>/g, (t, a) => {
    let n = "";
  ...
  capitalizeFirstLetter = e => `${e.charAt(0).toUpperCase()}${e.substring(1, e.length)}`.replace(/\./, ""),
  ...
  createMonths = (e, t) => {
    ...
    for (let t = 0; t < 12; t++) {
      const a = e.locale.months[t],
        n = t < e.dateMin.getMonth() + relationshipID(e) && r <= e.dateMin.getFullYear() || t > e.dateMax.getMonth() + relationshipID(e) && r >= e.dateMax.getFullYear() || t !== s && !d.includes(t),
        l = createMonthEl(e, c, s, a, n, t);
  ...
  getInputElement = (e, t, a) => e.querySelector(`.${t}${a ? ` input[name="${a}"]` : ""}`),
  addMouseEvents = (e, t, a) => {
  ...
  changeRange = (e, t, a, n, s, l) => {
    t.addEventListener("input", t => {
      ...
      i < l && i > 0 ? (a.value = d, e.selectedKeeping = "AM", n.innerText = e.selectedKeeping, setTime(e, t, d, s)) : (0 === i ? (e.selectedKeeping = "AM", n.innerText = "AM") : (e.selectedKeeping = "PM", n.innerText = "PM"), a.value = transformTime12(r.value), setTime(e, t, transformTime12(r.value), s));
    });
  },
  changeInput = (e, t, a, n, s, l) => {
    a.addEventListener("change", a => {
      const r = a.target,
        i = Number(r.value),
        d = i < 10 ? `0${i}` : `${i}`;
      "hours" === s && 12 === l ? r.value && i <= l && i > 0 ? (r.value = d, t.value = transformTime24(d, e.selectedKeeping), setTime(e, a, d, s)) : r.value && i < 24 && (i > l || 0 === i) ? (0 === i ? (e.selectedKeeping = "AM", n.innerText = "AM") : (e.selectedKeeping = "PM", n.innerText = "PM"), r.value = transformTime12(r.value), t.value = d, setTime(e, a, transformTime12(r.value), s)) : r.value = e.selectedHours : r.value && i <= l && i >= 0 ? (r.value = d, t.value = d, setTime(e, a, d, s)) : "hours" === s ? r.value = e.selectedHours : "minutes" === s && (r.value = e.selectedMinutes);
    });
  },
  ...
  changeTime = (e, t, a) => {
    const n = 24 === a ? 23 : a || 12,
      s = getInputElement(t, e.CSSClasses.timeRange, "hours"),
      l = getInputElement(t, e.CSSClasses.timeRange, "minutes"),
      r = getInputElement(t, e.CSSClasses.timeHours, "hours"),
      i = getInputElement(t, e.CSSClasses.timeMinutes, "minutes"),
  ...
  InputTime = (e, t, a, n) => `<label class="${t}"><input type="text"name="${e}"maxlength="2"value="${a}"${n ? "disabled" : ""}></label>`,
  RangeTime = (e, t, a, n, s, l) => `<label class="${t}"><input type="range"name="${e}"min="${a}"max="${n}"step="${s}"value="${l}"></label>`,
  createTime = e => {
  ...
  handleHoverDaysEvent = e => {
    ...
    const n = a.dataset.calendarDay,
      s = getDate(current.self.selectedDates[0]),
      l = getDate(n),
      r = current.self.HTMLElement.querySelectorAll(`[data-calendar-day="${current.self.selectedDates[0]}"]`),
      i = current.self.HTMLElement.querySelectorAll(`[data-calendar-day="${n}"]`),
      [d, c] = s < l ? [r, i] : [i, r],
      [o, u] = s < l ? [s, l] : [l, s];
    removeHoverEffect();
  ...
  updateDisabledDates = () => {
    ...
    const n = getDate(current.self.selectedDates[0]),
      [s, l] = current.self.rangeDisabled.map(e => getDate(e)).reduce(([e, t], a) => [n >= a ? a : e, n < a && null === t ? a : t], [null, null]);
  ...
  resetDisabledDates = () => {
    current.self && (current.self.rangeMin = current.rangeMin, current.self.rangeMax = current.rangeMax);
  },
  ...
  handleClickDay = (e, t) => {
    ...
    })[e.settings.selection.day](), null == (a = e.selectedDates) || a.sort((e, t) => +new Date(e) - +new Date(t)), e.actions.clickDay && e.actions.clickDay(t, e);
  ...
  handleItemClick = (e, t, a, n, s) => {
    ...
    ({
      year: () => {
        if ("multiple" === e.type) {
          const t = getColumnID(e, e.CSSClasses.columnYear, e.CSSClasses.year, Number(s.dataset.calendarYear), "data-calendar-selected-year"),
      ...
      month: () => {
        if ("multiple" === e.type) {
          const t = getColumnID(e, e.CSSClasses.columnMonth, e.CSSClasses.month, Number(s.dataset.calendarMonth), "data-calendar-selected-month"),
  ...
  handleClickMonthOrYear = (e, t, a, n) => {
    ...
    const s = t.target,
      ...
      c = l(e.CSSClasses.column);
    if (e.currentType !== a && r) {
      ({
        year: () => createYears(e, s),
        month: () => createMonths(e, s)
      })[a]();
    } else i ? handleItemClick(e, t, a, n, i) : (e.currentType === a && r || "multiple" === e.type && e.currentType === a && d && !c) && (e.currentType = e.type, create(e));
  },
  handleClick = e => {
    const t = t => {
  ...
  handleInput = e => {
    ...
    const n = () => setPositionCalendar(e.HTMLInputElement, e.HTMLElement, e.settings.visibility.positionToInput, e.CSSClasses),
      s = t => {
        var a;
    ...
    return e.HTMLInputElement.addEventListener("click", () => {
      t ? a.push((() => {
        ...
        return a.className = `${e.CSSClasses.calendar} ${e.CSSClasses.calendarToInput} ${e.CSSClasses.calendarHidden}`, e.HTMLElement = a, document.body.append(e.HTMLElement), t = !1, setTimeout(() => {
          setPositionCalendar(e.HTMLInputElement, a, e.settings.visibility.positionToInput, e.CSSClasses), e.show();
        }, 0), reset(e, {
          year: !0,
          month: !0,
          dates: !0,
          holidays: !0,
          time: !0
        }), e.actions.initCalendar && e.actions.initCalendar(e), handleClick(e);
      })()) : (setPositionCalendar(e.HTMLInputElement, e.HTMLElement, e.settings.visibility.positionToInput, e.CSSClasses), e.show()), window.addEventListener("resize", n), document.addEventListener("click", s, {
        capture: !0
      });
    }), () => {
      a.forEach(e => e());
  ...
  init = e => (e.HTMLOriginalElement = e.HTMLElement.cloneNode(!0), e.isInit = !0, e.input ? handleInput(e) : (setVariables(e), create(e), e.actions.initCalendar && e.actions.initCalendar(e), handleClick(e))),
  update = (e, {
    year: t,
    month: a,
    dates: n,
  ...
  show = e => {
    e.currentType ? (e.HTMLElement.classList.remove(e.CSSClasses.calendarHidden), e.actions.showCalendar && e.actions.showCalendar(e)) : e.HTMLElement.click();
  },
  hide = e => {
    e.currentType && (e.HTMLElement.classList.add(e.CSSClasses.calendarHidden), e.actions.hideCalendar && e.actions.hideCalendar(e));
  };
class VanillaCalendar extends DefaultOptionsCalendar {
  constructor(e, t) {
    if (super(), __publicField(this, "init", () => {
      return (e = this).HTMLOriginalElement = e.HTMLElement.cloneNode(!0), e.isInit = !0, e.input ? handleInput(e) : (setVariables(e), create(e), e.actions.initCalendar && e.actions.initCalendar(e), handleClick(e));
      var e;
    }), __publicField(this, "update", e => update(this, e)), __publicField(this, "destroy", () => destroy(this)), __publicField(this, "show", () => {
      var e;
...
export { VanillaCalendar as default };