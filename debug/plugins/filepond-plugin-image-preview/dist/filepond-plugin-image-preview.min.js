        ...
        write: e.utils.createRoute({
          ...
          DID_FINISH_CALCULATE_PREVIEWSIZE: function (e) {
            ...
            if (c) {
              var s,
                ...
                f = function (e) {
                  ...
                  if (o && s) {
                    ...
                    var u = Math.max(1, .75 * window.devicePixelRatio),
              ...
              if (s = c.file, h = window.navigator.userAgent.match(/Firefox\/([0-9]+)\./), !(null !== (u = h ? parseInt(h[1]) : null) && u <= 58) && "createImageBitmap" in window && L(s)) {
                var p = r(V);
                p.post({
                  file: c.file
                }, function (e) {
