...
(function (d, w) {
  typeof exports == "object" && typeof module < "u" ? module.exports = w() : typeof define == "function" && define.amd ? define(w) : (d = typeof globalThis < "u" ? globalThis : d || self, d.Table = w());
})(this, function () {
  "use strict";
  ...
  class c {
    ...
    render() {
      return this.wrapper = d("div", c.CSS.popover), this.items.forEach((e, t) => {
        const o = d("div", c.CSS.item),
          i = d("div", c.CSS.itemIcon, {
            innerHTML: e.icon
          }),
          r = d("div", c.CSS.itemLabel, {
            textContent: e.label
          });
  ...
  const b = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M8 8L12 12M12 12L16 16M12 12L16 8M12 12L8 16"/></svg>',
    ...
    L = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-width="2" d="M5 10H19"/><rect width="14" height="14" x="5" y="5" stroke="currentColor" stroke-width="2" rx="4"/></svg>',
    ...
    O = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-width="2" d="M10 5V18.5"/><path stroke="currentColor" stroke-width="2" d="M5 10H19"/><rect width="14" height="14" x="5" y="5" stroke="currentColor" stroke-width="2" rx="4"/></svg>';
  class u {
    constructor({
      api: e,
      items: t,
  ...
  class A {
    constructor(e, t, o, i) {
      this.readOnly = e, this.api = t, this.data = o, this.config = i, this.wrapper = null, this.table = null, this.toolboxColumn = this.createColumnToolbox(), this.toolboxRow = this.createRowToolbox(), this.createTableWrapper(), this.hoveredRow = 0, this.hoveredColumn = 0, this.selectedRow = 0, this.selectedColumn = 0, this.tunes = {
        ...
        p && p.parentNode === this.wrapper ? (this.addRow(void 0, !0), this.hideToolboxes()) : f && f.parentNode === this.wrapper && (this.addColumn(void 0, !0), this.hideToolboxes());
    ...
    fill() {
      const e = this.data;
      if (e && e.content) for (let t = 0; t < e.content.length; t++) for (let o = 0; o < e.content[t].length; o++) this.setCellContent(t + 1, o + 1, e.content[t][o]);
    }
    fillRow(e, t) {
      for (let o = 1; o <= t; o++) {
    ...
    setHeadingsSetting(e) {
      this.tunes.withHeadings = e, e ? (this.table.classList.add(s.withHeadings), this.addHeadingAttrToFirstRow()) : (this.table.classList.remove(s.withHeadings), this.removeHeadingAttrFromFirstRow());
    }
    ...
    binSearch(e, t, o, i) {
      ...
      for (; r < n - 1 && h < 10;) {
        ...
        const p = t(l),
          f = g(this.table, p);
        if (o(f)) n = l;else if (i(f)) r = l;else break;
        h++;
      }
      return l;
    }
  ...
  class E {
    ...
    render() {
      return this.table = new A(this.readOnly, this.api, this.data, this.config), this.container = d("div", this.api.styles.block), this.container.appendChild(this.table.getWrapper()), this.table.setHeadingsSetting(this.data.withHeadings), this.container;
    }
    renderSettings() {
      return [{
