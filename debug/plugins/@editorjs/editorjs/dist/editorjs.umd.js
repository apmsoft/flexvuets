(function (de, J) {
  typeof exports == "object" && typeof module < "u" ? module.exports = J() : typeof define == "function" && define.amd ? define(J) : (de = typeof globalThis < "u" ? globalThis : de || self, de.EditorJS = J());
})(this, function () {
  "use strict";
  ...
  function he(s, e, t = "log", o, i = "color: inherit") {
  ...
  async function Ft(s, e = () => {}, t = () => {}) {
    async function o(i, n, r) {
      try {
        await i.function(i.data), await n(et(i.data) ? {} : i.data);
      } catch {
        r(et(i.data) ? {} : i.data);
      }
    }
  ...
  function Me(s, ...e) {
    ...
    const t = e.shift();
    if (O(s) && O(t)) for (const o in t) O(t[o]) ? (s[o] || Object.assign(s, {
      [o]: {}
  ...
  const nt = 650;
  function ee() {
    return window.matchMedia(`(max-width: ${nt}px)`).matches;
  }
  ...
  const rt = {
    ...
    re = class {
      ...
      static setDictionary(s) {
        re.currentDictionary = s;
      }
      static _t(s, e) {
        const t = re.getNamespace(s);
        return !t || !t[e] ? e : t[e];
      }
      static getNamespace(s) {
        return s.split(".").reduce((t, o) => !t || !Object.keys(t).length ? {} : t[o], re.currentDictionary);
      }
    };
  let H = re;
  ...
  class N extends ye {
    ...
    set selected(e) {
      ...
      const t = e === !0 && g.isRangeInsideContainer(this.holder),
    ...
    async exportDataAsString() {
      ...
      return Vt(e, this.tool.conversionConfig);
    }
    compose() {
      const e = c.make("div", N.CSS.wrapper),
    ...
    constructor() {
      super(...arguments), this.insert = (e = this.config.defaultBlock, t = {}, o = {}, i, n, r, a) => {
        ...
        if (d && u) i.convert(r, t, o);else {
          const x = [d ? !1 : ne(r.name), u ? !1 : ne(t)].filter(Boolean).join(" and ");
...
`);
        ...
        function z(v, b) {
          ...
          if (b.singleton) {
            ...
            var ie = ve.css,
              Ge = ve.sourceMap,
              ki = $.convertToAbsoluteUrls === void 0 && Ge;
            ($.convertToAbsoluteUrls || ki) && (ie = x(ie)), Ge && (ie += `
/*# sourceMappingURL=data:application/json;base64,` + btoa(unescape(encodeURIComponent(JSON.stringify(Ge)))) + " */");
            var vi = new Blob([ie], {
                type: "text/css"
              }),
              Ot = B.href;
            B.href = URL.createObjectURL(vi), Ot && URL.revokeObjectURL(Ot);
          }.bind(null, w, b), I = function () {
...
`);
  ...
  const pe = class {
    ...
    next() {
      this.cursor = this.leafNodesAndReturnIndex(pe.directions.RIGHT);
    }
    previous() {
      this.cursor = this.leafNodesAndReturnIndex(pe.directions.LEFT);
    }
    dropCursor() {
    ...
    leafNodesAndReturnIndex(s) {
      ...
      let e = this.cursor;
      return e === -1 ? e = s === pe.directions.RIGHT ? -1 : 0 : this.items[e].classList.remove(this.focusedCssClass), s === pe.directions.RIGHT ? e = (e + 1) % this.items.length : e = (this.items.length + e - 1) % this.items.length, c.canSetCaret(this.items[e]) && xe(() => g.setCursor(this.items[e]), 50)(), this.items[e].classList.add(this.focusedCssClass), e;
    }
  };
  let ae = pe;
  ae.directions = {
  ...
  class fe {
    ...
    render(e) {
      ...
      const t = c.make("div", fe.CSS.icon, {
        innerHTML: Oo
      });
  ...
  const ge = class {
    lock() {
      st ? this.lockHard() : document.body.classList.add(ge.CSS.scrollLocked);
    }
    unlock() {
      st ? this.unlockHard() : document.body.classList.remove(ge.CSS.scrollLocked);
    }
    lockHard() {
      this.scrollPosition = window.pageYOffset, document.documentElement.style.setProperty("--window-scroll-offset", `${this.scrollPosition}px`), document.body.classList.add(ge.CSS.scrollLockedHard);
    }
    unlockHard() {
  ...
  const R = class extends ye {
    ...
    addSearch() {
      ...
      s.classList.add(R.CSS.search), this.nodes.popover.insertBefore(s, this.nodes.popover.firstChild);
    }
    addCustomContent(s) {
    ...
    get height() {
      ...
      return e.style.visibility = "hidden", e.style.position = "absolute", e.style.top = "-1000px", e.classList.add(R.CSS.popoverOpened), document.body.appendChild(e), s = e.offsetHeight, e.remove(), s;
    }
    ...
    toggleNothingFoundMessage(s) {
      this.nodes.nothingFoundMessage.classList.toggle(R.CSS.nothingFoundMessageDisplayed, s);
    }
    toggleCustomContent(s) {
      var e;
      (e = this.nodes.customContent) == null || e.classList.toggle(R.CSS.customContentHidden, s);
    }
  ...
  class U extends y {
    ...
    make() {
      this.nodes.wrapper = c.make("div", [U.CSS.conversionToolbarWrapper, ...(this.isRtl ? [this.Editor.UI.CSS.editorRtlFix] : [])]), this.nodes.tools = c.make("div", U.CSS.conversionToolbarTools);
      const e = c.make("div", U.CSS.conversionToolbarLabel, {
    ...
    addTool(e, t) {
      var r;
      const o = c.make("div", [U.CSS.conversionTool]),
      ...
      if (n) {
        const a = c.make("span", U.CSS.conversionToolSecondaryLabel, {
          innerText: we(n)
        });
        c.append(o, a);
      }
  ...
  const kt = class extends ye {
    ...
    make() {
      ...
      }), this.popover.on(be.Close, this.onPopoverClose), this.enableShortcuts(), this.nodes.toolbox = this.popover.getElement(), this.nodes.toolbox.classList.add(kt.CSS.toolbox), this.nodes.toolbox;
    }
    hasFocus() {
      var s;
  ...
  class Yo extends y {
    ...
    makeToolbox() {
      ...
      }), this.toolboxInstance.on(Ee.Opened, () => {
        this.Editor.UI.nodes.wrapper.classList.add(this.CSS.openedToolboxHolderModifier);
      }), this.toolboxInstance.on(Ee.Closed, () => {
        this.Editor.UI.nodes.wrapper.classList.remove(this.CSS.openedToolboxHolderModifier);
      }), this.toolboxInstance.on(Ee.BlockAdded, ({
        block: e
      }) => {
        const {
            BlockManager: t,
  ...
  class Ko extends y {
    constructor({
      ...
      }, this.opened = !1, this.toolbarVerticalMargin = ee() ? 20 : 6, this.buttonsList = null, this.width = 0, this.flipper = null;
    }
    toggleReadOnly(e) {
    ...
    close() {
      this.opened && (this.Editor.ReadOnly.isEnabled || (this.nodes.wrapper.classList.remove(this.CSS.inlineToolbarShowed), Array.from(this.toolsInstances.entries()).forEach(([e, t]) => {
        ...
        o && le.remove(this.Editor.UI.nodes.redactor, o), M(t.clear) && t.clear();
  ...
  class Zo extends y {
    ...
    async update(e, t) {
      ...
      return this._blocks.replace(n, i), this.blockDidMutated(Bt, i, {
        index: n
      }), i;
    }
    replace(e, t, o) {
    ...
    move(e, t = this.currentBlockIndex) {
      ...
      this._blocks.move(e, t), this.currentBlockIndex = e, this.blockDidMutated(Vo, this.currentBlock, {
        fromIndex: t,
        toIndex: e
      });
    }
...
`),
  ...
  var ai = Object.defineProperty,
    ...
    It = (s, e, t, o) => {
      for (var i = o > 1 ? void 0 : o ? li(e, t) : e, n = s.length - 1, r; n >= 0; n--) (r = s[n]) && (i = (o ? r(e, t, i) : r(i)) || i);
  ...
  class Ze extends We {
    ...
    get toolbox() {
      const e = this.constructable[ce.Toolbox],
  ...
  var di = Object.defineProperty,
    ...
    ui = (s, e, t, o) => {
      for (var i = o > 1 ? void 0 : o ? hi(e, t) : e, n = s.length - 1, r; n >= 0; n--) (r = s[n]) && (i = (o ? r(e, t, i) : r(i)) || i);
  ...
  class _t extends y {
    ...
    prepareConfig() {
      const e = {};
      for (const t in this.config.tools) O(this.config.tools[t]) ? e[t] = this.config.tools[t] : e[t] = {
        class: this.config.tools[t]
      };
      return e;
    }
  }
  ui([se], _t.prototype, "getAllInlineToolsSanitizeConfig", 1);
...
`;
  class fi extends y {
    constructor() {
      super(...arguments), this.isMobile = !1, this.contentRectCache = void 0, this.resizeDebouncer = it(() => {
        this.windowResize();
      }, 200);
    }
    get CSS() {
    ...
    selectionChanged() {
      ...
      const i = o.closest(`.${N.CSS.content}`) === null;
  ...
  const gi = {
    ...
    BlockSelection: Go,
    Caret: Ce,
    CrossBlockSelection: Jo,
    DragNDrop: Qo,
    ModificationsObserver: ei,
    Paste: Ct,
    ReadOnly: ti,
  ...
  class bi {
    ...
    validate() {
      ...
      if (Z(t) && !c.get(t)) throw Error(`element with ID «${t}» is missing. Pass correct holder's ID.`);
