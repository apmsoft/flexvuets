...
import { CKEditorError, EmitterMixin } from "../../../ckeditor5-editor-classic/src/index.js/ckeditor5-utils";
/**
...
export default class MarkerCollection extends EmitterMixin() {
  ...
  _set(markerOrName, range, managedUsingOperations = false, affectsData = false) {
    ...
    this.fire(`update:${markerName}`, marker, null, range, Object.assign(Object.assign({}, marker.getData()), {
      range: null
    }));
    return marker;
  }
