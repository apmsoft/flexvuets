...
import { CKEditorError, Collection, EmitterMixin, isInsideSurrogatePair, isInsideCombinedSymbol } from "../../../ckeditor5-editor-classic/src/index.js/ckeditor5-utils";
...
export default class Document extends EmitterMixin() {
  ...
  constructor(model) {
    ...
    this.listenTo(model.markers, 'update', (evt, marker, oldRange, newRange, oldMarkerData) => {
      ...
      const newMarkerData = Object.assign(Object.assign({}, marker.getData()), {
        range: newRange
      });
      ...
      if (oldRange === null) {
        ...
        marker.on('change', (evt, oldRange) => {
          ...
          this.differ.bufferMarkerChange(marker.name, Object.assign(Object.assign({}, markerData), {
            range: oldRange
          }), markerData);
        });
      }
