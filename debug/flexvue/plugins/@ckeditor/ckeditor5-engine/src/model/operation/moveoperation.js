...
import { CKEditorError, compareArrays } from "../../../../ckeditor5-editor-classic/src/index.js/ckeditor5-utils";
...
export default class MoveOperation extends Operation {
  ...
  get affectedSelectable() {
    return [Range._createFromPositionAndShift(this.sourcePosition, this.howMany), Range._createFromPositionAndShift(this.targetPosition, 0)];
  }
  /**
