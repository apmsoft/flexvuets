...
import { EmitterMixin } from "../../../ckeditor5-editor-classic/src/index.js/ckeditor5-utils";
/**
...
export default class DowncastDispatcher extends EmitterMixin() {
  ...
  constructor(conversionApi) {
    super();
    this._conversionApi = Object.assign({
      dispatcher: this
    }, conversionApi);
  ...
  _convertReinsert(range, conversionApi) {
    ...
    for (const data of walkerValues.map(walkerValueToEventData)) {
      this._testAndFire('insert', Object.assign(Object.assign({}, data), {
        reconversion: true
      }), conversionApi);
    }
  }
  ...
  _createConversionApi(writer, refreshedItems = new Set(), options = {}) {
    const conversionApi = Object.assign(Object.assign({}, this._conversionApi), {
