...
import dropdownArrowIcon from "../../../../ckeditor5-editor-classic/src/index.js/ckeditor5-ui/theme/icons/dropdown-arrow.svg";
...
export default class CollapsibleView extends View {
  ...
  constructor(locale, childViews) {
    ...
    this.setTemplate({
      tag: 'div',
      attributes: {
        class: ['ck', 'ck-collapsible', bind.if('isCollapsed', 'ck-collapsible_collapsed')]
      },
