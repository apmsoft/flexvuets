...
export function getAllListItemBlocks(listItem, options = {}) {
  return [...getListItemBlocks(listItem, Object.assign(Object.assign({}, options), {
    direction: 'backward'
  })), ...getListItemBlocks(listItem, Object.assign(Object.assign({}, options), {
    direction: 'forward'
  }))];
}
/**
...
export function getListItemBlocks(listItem, options = {}) {
  ...
  const items = Array.from(new ListWalker(listItem, Object.assign(Object.assign({}, options), {
 ...
 */
export function indentBlocks(blocks, writer, {
  expand,
  indentBy = 1
} = {}) {
  blocks = toArray(blocks);
...
export function outdentFollowingItems(lastBlock, writer) {
  ...
  for (const {
    node
  } of iterateSiblingListBlocks(lastBlock.nextSibling, 'forward')) {
