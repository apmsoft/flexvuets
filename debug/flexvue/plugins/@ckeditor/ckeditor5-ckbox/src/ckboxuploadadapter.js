...
class Adapter {
   ...
   */
  getAvailableCategories(offset = 0) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      return this._sendHttpRequest({
        url: categoryUrl
      }).then(data => __awaiter(this, void 0, void 0, function* () {
        const remainingItems = data.totalCount - (offset + ITEMS_PER_REQUEST);
        if (remainingItems > 0) {
          const offsetItems = yield this.getAvailableCategories(offset + ITEMS_PER_REQUEST);
          return [...data.items, ...offsetItems];
        }
        return data.items;
      })).catch(() => {
   ...
   */
  getCategoryIdForFile(file) {
    return __awaiter(this, void 0, void 0, function* () {
      const extension = getFileExtension(file.name);
      const allCategories = yield this.getAvailableCategories();
  ...
  upload() {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const file = yield this.loader.file;
      const category = yield this.getCategoryIdForFile(file);
      if (!category) {
      ...
      return this._sendHttpRequest(requestConfig).then(data => __awaiter(this, void 0, void 0, function* () {
