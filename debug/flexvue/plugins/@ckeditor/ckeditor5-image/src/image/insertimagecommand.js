  ...
  execute(options) {
    ...
    sourceDefinitions.forEach((sourceDefinition, index) => {
      ...
      if (index && selectedElement && imageUtils.isImage(selectedElement)) {
        ...
        imageUtils.insertImage(Object.assign(Object.assign({}, sourceDefinition), selectionAttributes), position);
      } else {
        imageUtils.insertImage(Object.assign(Object.assign({}, sourceDefinition), selectionAttributes));
      }
    });
  }
}