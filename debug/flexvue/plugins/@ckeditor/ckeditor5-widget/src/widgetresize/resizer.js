...
import { Rect, ObservableMixin, compareArrays } from "../../../ckeditor5-editor-classic/src/index.js/ckeditor5-utils";
...
export default class Resizer extends ObservableMixin() {
  ...
  updateSize(domEventData) {
    ...
    this.state.update(Object.assign(Object.assign({}, newSize), {
      handleHostWidth,
      handleHostHeight
    }));
  }
