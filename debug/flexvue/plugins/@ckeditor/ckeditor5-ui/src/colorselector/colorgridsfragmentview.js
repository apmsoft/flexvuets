...
import removeButtonIcon from "../../../ckeditor5-editor-classic/src/index.js/ckeditor5-core/theme/icons/eraser.svg";
...
export default class ColorGridsFragmentView extends View {
  ...
  constructor(locale, {
    ...
    this.setTemplate({
      tag: 'div',
      attributes: {
        class: ['ck-color-grids-fragment', bind.if('isVisible', 'ck-hidden', value => !value)]
      },
      children: this.items
    });
