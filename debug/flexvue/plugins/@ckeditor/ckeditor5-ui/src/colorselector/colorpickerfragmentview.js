...
import checkButtonIcon from "../../../ckeditor5-editor-classic/src/index.js/ckeditor5-core/theme/icons/check.svg";
import cancelButtonIcon from "../../../ckeditor5-editor-classic/src/index.js/ckeditor5-core/theme/icons/cancel.svg";
/**
...
export default class ColorPickerFragmentView extends View {
  ...
  constructor(locale, {
    ...
    this.setTemplate({
      tag: 'div',
      attributes: {
        class: ['ck-color-picker-fragment', bind.if('isVisible', 'ck-hidden', value => !value)]
      },
      children: this.items
    });
  }
  ...
  render() {
    super.render();
    const colorPickerView = new ColorPickerView(this.locale, Object.assign({}, this._colorPickerViewConfig));
  ...
  _createActionBarView({
    ...
    actionBarRow.setTemplate({
      tag: 'div',
      attributes: {
        class: ['ck', 'ck-color-selector_action-bar']
      },
      children
    });
    return actionBarRow;
