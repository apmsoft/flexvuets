...
*/
import { FocusTracker, KeystrokeHandler } from "../../../../ckeditor5-editor-classic/src/index.js/ckeditor5-utils";
...
export default class SearchTextView extends View {
  ...
  search(query) {
    ...
    this.fire('search', Object.assign({
      query
    }, filteringResults));
  }
  /**
