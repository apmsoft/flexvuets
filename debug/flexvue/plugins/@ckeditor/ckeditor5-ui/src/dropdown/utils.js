...
import { global, priorities, logWarning } from "../../../ckeditor5-editor-classic/src/index.js/ckeditor5-utils";
...
function closeDropdownOnClickOutside(dropdownView) {
  dropdownView.on('render', () => {
    clickOutsideHandler({
      ...
      contextElements: () => [dropdownView.element, ...dropdownView.focusTracker._elements]
    });
  });
}
/**
