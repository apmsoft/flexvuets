...
import { global, toUnit, Rect } from "../../../../ckeditor5-editor-classic/src/index.js/ckeditor5-utils";
  ...
  constructor(locale) {
    ...
    this._contentPanel = new Template({
      ...
      attributes: {
        ...
        bind.if('isSticky', 'ck-sticky-panel__content_sticky'), bind.if('_isStickyToTheBottomOfLimiter', 'ck-sticky-panel__content_sticky_bottom-limit')],
        style: {
