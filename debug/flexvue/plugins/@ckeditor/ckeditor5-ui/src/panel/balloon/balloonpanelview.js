...
import { getOptimalPosition, global, isRange, toUnit } from "../../../../ckeditor5-editor-classic/src/index.js/ckeditor5-utils";
...
export function generatePositions(options = {}) {
  ...
  return {
    // ------- North west
    northWestArrowSouthWest: (targetRect, balloonRect) => Object.assign({
    ...
    northWestArrowSouthMiddleWest: (targetRect, balloonRect) => Object.assign({
      top: getNorthTop(targetRect, balloonRect),
    ...
    northWestArrowSouth: (targetRect, balloonRect) => Object.assign({
      top: getNorthTop(targetRect, balloonRect),
    ...
    northWestArrowSouthMiddleEast: (targetRect, balloonRect) => Object.assign({
      top: getNorthTop(targetRect, balloonRect),
    ...
    northWestArrowSouthEast: (targetRect, balloonRect) => Object.assign({
      top: getNorthTop(targetRect, balloonRect),
    ...
    // ------- North
    northArrowSouthWest: (targetRect, balloonRect) => Object.assign({
      top: getNorthTop(targetRect, balloonRect),
    ...
    northArrowSouthMiddleWest: (targetRect, balloonRect) => Object.assign({
      top: getNorthTop(targetRect, balloonRect),
    ...
    northArrowSouth: (targetRect, balloonRect) => Object.assign({
      top: getNorthTop(targetRect, balloonRect),
    ...
    northArrowSouthMiddleEast: (targetRect, balloonRect) => Object.assign({
      top: getNorthTop(targetRect, balloonRect),
    ...
    northArrowSouthEast: (targetRect, balloonRect) => Object.assign({
      top: getNorthTop(targetRect, balloonRect),
    ...
    // ------- North east
    northEastArrowSouthWest: (targetRect, balloonRect) => Object.assign({
      top: getNorthTop(targetRect, balloonRect),
    ...
    northEastArrowSouthMiddleWest: (targetRect, balloonRect) => Object.assign({
      top: getNorthTop(targetRect, balloonRect),
    ...
    northEastArrowSouth: (targetRect, balloonRect) => Object.assign({
      top: getNorthTop(targetRect, balloonRect),
    ...
    northEastArrowSouthMiddleEast: (targetRect, balloonRect) => Object.assign({
      top: getNorthTop(targetRect, balloonRect),
    ...
    northEastArrowSouthEast: (targetRect, balloonRect) => Object.assign({
      top: getNorthTop(targetRect, balloonRect),
    ...
    // ------- South west
    southWestArrowNorthWest: targetRect => Object.assign({
    ...
    southWestArrowNorthMiddleWest: (targetRect, balloonRect) => Object.assign({
      top: getSouthTop(targetRect),
      left: targetRect.left - balloonRect.width * .25 - sideOffset,
      name: 'arrow_nmw'
    }, config && {
    ...
    southWestArrowNorth: (targetRect, balloonRect) => Object.assign({
      top: getSouthTop(targetRect),
      left: targetRect.left - balloonRect.width / 2,
      name: 'arrow_n'
    }, config && {
    ...
    southWestArrowNorthMiddleEast: (targetRect, balloonRect) => Object.assign({
      top: getSouthTop(targetRect),
      left: targetRect.left - balloonRect.width * .75 + sideOffset,
      name: 'arrow_nme'
    }, config && {
    ...
    southWestArrowNorthEast: (targetRect, balloonRect) => Object.assign({
      top: getSouthTop(targetRect),
      left: targetRect.left - balloonRect.width + sideOffset,
      name: 'arrow_ne'
    }, config && {
    ...
    // ------- South
    southArrowNorthWest: targetRect => Object.assign({
      top: getSouthTop(targetRect),
      left: targetRect.left + targetRect.width / 2 - sideOffset,
      name: 'arrow_nw'
    }, config && {
    ...
    southArrowNorthMiddleWest: (targetRect, balloonRect) => Object.assign({
      top: getSouthTop(targetRect),
    ...
    southArrowNorth: (targetRect, balloonRect) => Object.assign({
      top: getSouthTop(targetRect),
      left: targetRect.left + targetRect.width / 2 - balloonRect.width / 2,
      name: 'arrow_n'
    }, config && {
    ...
    southArrowNorthMiddleEast: (targetRect, balloonRect) => Object.assign({
      top: getSouthTop(targetRect),
    ...
    southArrowNorthEast: (targetRect, balloonRect) => Object.assign({
      top: getSouthTop(targetRect),
      left: targetRect.left + targetRect.width / 2 - balloonRect.width + sideOffset,
      name: 'arrow_ne'
    }, config && {
    ...
    // ------- South east
    southEastArrowNorthWest: targetRect => Object.assign({
      top: getSouthTop(targetRect),
      left: targetRect.right - sideOffset,
      name: 'arrow_nw'
    }, config && {
    ...
    southEastArrowNorthMiddleWest: (targetRect, balloonRect) => Object.assign({
      top: getSouthTop(targetRect),
      left: targetRect.right - balloonRect.width * .25 - sideOffset,
      name: 'arrow_nmw'
    }, config && {
    ...
    southEastArrowNorth: (targetRect, balloonRect) => Object.assign({
      top: getSouthTop(targetRect),
      left: targetRect.right - balloonRect.width / 2,
      name: 'arrow_n'
    }, config && {
    ...
    southEastArrowNorthMiddleEast: (targetRect, balloonRect) => Object.assign({
      top: getSouthTop(targetRect),
      left: targetRect.right - balloonRect.width * .75 + sideOffset,
      name: 'arrow_nme'
    }, config && {
    ...
    southEastArrowNorthEast: (targetRect, balloonRect) => Object.assign({
      top: getSouthTop(targetRect),
      left: targetRect.right - balloonRect.width + sideOffset,
      name: 'arrow_ne'
    }, config && {
    ...
    // ------- West
    westArrowEast: (targetRect, balloonRect) => Object.assign({
    ...
    // ------- East
    eastArrowWest: (targetRect, balloonRect) => Object.assign({
      top: targetRect.top + targetRect.height / 2 - balloonRect.height / 2,
