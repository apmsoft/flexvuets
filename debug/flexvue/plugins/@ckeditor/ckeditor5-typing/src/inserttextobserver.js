 ...
 */
import { env, EventInfo } from "../../ckeditor5-editor-classic/src/index.js/ckeditor5-utils";
import { DomEventData, Observer, FocusObserver } from "../../ckeditor5-editor-classic/src/index.js/ckeditor5-engine";
...
export default class InsertTextObserver extends Observer {
  ...
  constructor(view) {
    ...
    viewDocument.on('compositionend', (evt, {
      data,
      domEvent
    }) => {
