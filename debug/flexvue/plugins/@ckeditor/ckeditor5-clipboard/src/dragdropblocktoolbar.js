...
import { env, global, DomEmitterMixin } from "../../ckeditor5-editor-classic/src/index.js/ckeditor5-utils";
...
export default class DragDropBlockToolbar extends Plugin {
  ...
  _handleBlockDragging(domEvent) {
    ...
    view.getObserver(ClipboardObserver).onDomEvent(Object.assign(Object.assign({}, domEvent), {
      type: domEvent.type,
