...
(() => {
  var e = {
      ...
      626: (e, t, i) => {
        ...
        o.push([e.id, ".ck.ck-link-form{display:flex}.ck.ck-link-form .ck-label{display:none}@media screen and (max-width:600px){.ck.ck-link-form{flex-wrap:wrap}.ck.ck-link-form .ck-labeled-field-view{flex-basis:100%}.ck.ck-link-form .ck-button{flex-basis:50%}}.ck.ck-link-form_layout-vertical{display:block}.ck.ck-link-form_layout-vertical .ck-button.ck-button-cancel,.ck.ck-link-form_layout-vertical .ck-button.ck-button-save{margin-top:var(--ck-spacing-medium)}.ck.ck-link-form_layout-vertical{min-width:var(--ck-input-width);padding:0}.ck.ck-link-form_layout-vertical .ck-labeled-field-view{margin:var(--ck-spacing-large) var(--ck-spacing-large) var(--ck-spacing-small)}.ck.ck-link-form_layout-vertical .ck-labeled-field-view .ck-input-text{min-width:0;width:100%}.ck.ck-link-form_layout-vertical>.ck-button{border-radius:0;margin:0;padding:var(--ck-spacing-standard);width:50%}.ck.ck-link-form_layout-vertical>.ck-button:not(:focus){border-top:1px solid var(--ck-color-base-border)}[dir=ltr] .ck.ck-link-form_layout-vertical>.ck-button,[dir=rtl] .ck.ck-link-form_layout-vertical>.ck-button{margin-left:0}[dir=rtl] .ck.ck-link-form_layout-vertical>.ck-button:last-of-type{border-right:1px solid var(--ck-color-base-border)}.ck.ck-link-form_layout-vertical .ck.ck-list{margin:var(--ck-spacing-standard) var(--ck-spacing-large)}.ck.ck-link-form_layout-vertical .ck.ck-list .ck-button.ck-switchbutton{padding:0;width:100%}.ck.ck-link-form_layout-vertical .ck.ck-list .ck-button.ck-switchbutton:hover{background:none}", ""]);
        const s = o;
      },
      883: (e, t, i) => {
        "use strict";
        ...
        e.exports = function (e) {
          ...
          return t.toString = function () {
            ...
            for (var a = 0; a < e.length; a++) {
              var c = [].concat(e[a]);
              n && o[c[0]] || (i && (c[2] ? c[2] = "".concat(i, " and ").concat(c[2]) : c[2] = i), t.push(c));
            }
          }, t;
        };
      },
      62: (e, t, i) => {
        ...
        var n,
          ...
          r = [];
        function a(e) {
          for (var t = -1, i = 0; i < r.length; i++) if (r[i].identifier === e) {
            t = i;
            break;
          }
          return t;
        ...
        function c(e, t) {
          for (var i = {}, n = [], o = 0; o < e.length; o++) {
            ...
            -1 !== d ? (r[d].references++, r[d].updater(k)) : r.push({
              identifier: u,
              updater: g(k, t),
              references: 1
            }), n.push(u);
        ...
        function g(e, t) {
          ...
          if (t.singleton) {
            var s = m++;
            i = f || (f = l(t)), n = k.bind(null, i, s, !1), o = k.bind(null, i, s, !0);
          } else i = l(t), n = h.bind(null, i, t), o = function () {
            !function (e) {
  ...
  (() => {
    ...
    class a {
        ...
        return e => {
          e.on("attribute:linkHref", (e, t, i) => {
            ...
            for (const e of this._definitions) {
              const s = n.createAttributeElement("a", e.attributes, {
                priority: 5
              });
              e.classes && n.addClass(e.classes, s);
              for (const t in e.styles) n.setStyle(t, e.styles[t], s);
              n.setCustomProperty("link", !0, s), e.callback(t.attributeNewValue) ? t.item.is("selection") ? n.wrap(o.getFirstRange(), s) : n.wrap(i.mapper.toViewRange(t.range), s) : n.unwrap(i.mapper.toViewRange(t.range), s);
            }
          }, {
            priority: "high"
          });
      ...
      getDispatcherForLinkedImage() {
        return e => {
          e.on("attribute:linkHref:imageBlock", (e, t, {
            writer: i,
            mapper: n
          }) => {
            const o = n.toViewElement(t.item),
              s = Array.from(o.getChildren()).find(e => e.is("element", "a"));
            for (const e of this._definitions) {
              const n = (0, r.toMap)(e.attributes);
              if (e.callback(t.attributeNewValue)) {
                for (const [e, t] of n) "class" === e ? i.addClass(t, s) : i.setAttribute(e, t, s);
                e.classes && i.addClass(e.classes, s);
                for (const t in e.styles) i.setStyle(t, e.styles[t], s);
              } else {
                for (const [e, t] of n) "class" === e ? i.removeClass(t, s) : i.removeAttribute(e, s);
    ...
    const l = function (e, t, i) {
      var n = e.length;
      return i = void 0 === i ? n : i, !t && i >= n ? e : c(e, t, i);
    };
    ...
    const E = (S || T || Function("return this")()).Symbol;
    ...
    const N = function (e) {
      ...
      var o = j.call(e);
      return n && (t ? e[B] = i : delete e[B]), o;
    };
    var H = Object.prototype.toString;
    const O = function (e) {
      return H.call(e);
    };
    var P = E ? E.toStringTag : void 0;
    const U = function (e) {
      return null == e ? void 0 === e ? "[object Undefined]" : "[object Null]" : P && P in Object(e) ? N(e) : O(e);
    };
    const F = function (e) {
      return null != e && "object" == typeof e;
    };
    const R = function (e) {
      return "symbol" == typeof e || F(e) && "[object Symbol]" == U(e);
    };
    var z = E ? E.prototype : void 0,
      Z = z ? z.toString : void 0;
    const q = function e(t) {
      if ("string" == typeof t) return t;
      if (L(t)) return C(t, e) + "";
      if (R(t)) return Z ? Z.call(t) : "";
      var i = t + "";
    ...
    const K = function (e) {
        return function (t) {
          t = $(t);
          var i = d(t) ? V(t) : void 0,
            n = i ? i[0] : t.charAt(0),
            o = i ? l(i, 1).join("") : t.slice(1);
          return n[e]() + o;
        };
      }("toUpperCase"),
      Q = /[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205f\u3000]/g,
      W = /^(?:(?:https?|ftps?|mailto):|[^a-z]|[a-z+.-]+(?:[^a-z+.:-]|$))/i,
      Y = /^[\S]+@((?![-_])(?:[-\w\u00a1-\uffff]{0,63}[^-_]\.))+(?:[a-z\u00a1-\uffff]{2,})$/i,
      G = /^((\w+:(\/{2,})?)|(\W))/i,
      J = "Ctrl+K";
    function X(e, {
      writer: t
    ...
    class se extends e.Command {
      constructor() {
        super(...arguments), this.manualDecorators = new r.Collection(), this.automaticDecorators = new a();
      }
      ...
      refresh() {
        const e = this.editor.model,
          ...
          i = t.getSelectedElement() || (0, r.first)(t.getSelectedBlocks());
        te(i, e.schema) ? (this.value = i.getAttribute("linkHref"), this.isEnabled = e.schema.checkAttribute(i, "linkHref")) : (this.value = t.getAttribute("linkHref"), this.isEnabled = e.schema.checkAttributeInSelection(t, "linkHref"));
        for (const e of this.manualDecorators) e.value = this._getDecoratorStateFromModel(e.id);
      }
      execute(e, t = {}) {
        const i = this.editor.model,
          ...
          s = [],
          a = [];
        for (const e in t) t[e] ? s.push(e) : a.push(e);
        i.change(t => {
          if (n.isCollapsed) {
            const c = n.getFirstPosition();
            if (n.hasAttribute("linkHref")) {
              const r = re(n);
              let l = (0, o.findAttributeRange)(c, "linkHref", n.getAttribute("linkHref"), i);
              n.getAttribute("linkHref") === r && (l = this._updateLinkContent(i, t, l, e)), t.setAttribute("linkHref", e, l), s.forEach(e => {
                t.setAttribute(e, !0, l);
              }), a.forEach(e => {
                t.removeAttribute(e, l);
              }), t.setSelection(t.createPositionAfter(l.end.nodeBefore));
            } else if ("" !== e) {
              const o = (0, r.toMap)(n.getAttributes());
              o.set("linkHref", e), s.forEach(e => {
                o.set(e, !0);
              });
              const {
                end: a
              } = i.insertContent(t.createText(e, o), c);
              t.setSelection(a);
            }
            ["linkHref", ...s, ...a].forEach(e => {
              t.removeSelectionAttribute(e);
            });
          } else {
            const o = i.schema.getValidRanges(n.getRanges(), "linkHref"),
              r = [];
            for (const e of n.getSelectedBlocks()) i.schema.checkAttribute(e, "linkHref") && r.push(t.createRangeOn(e));
            const c = r.slice();
            for (const e of o) this._isRangeToUpdate(e, r) && c.push(e);
            for (const o of c) {
              let r = o;
              if (1 === c.length) {
                const s = re(n);
                n.getAttribute("linkHref") === s && (r = this._updateLinkContent(i, t, o, e), t.setSelection(t.createSelection(r)));
              }
              t.setAttribute("linkHref", e, r), s.forEach(e => {
      ...
      _getDecoratorStateFromModel(e) {
        ...
        return te(n, t.schema) ? n.getAttribute(e) : i.getAttribute(e);
      }
    ...
    class ae extends e.Command {
      refresh() {
        ...
        te(i, e.schema) ? this.isEnabled = e.schema.checkAttribute(i, "linkHref") : this.isEnabled = e.schema.checkAttributeInSelection(t, "linkHref");
      }
      execute() {
        const e = this.editor,
          t = this.editor.model,
        ...
        t.change(e => {
          const s = i.isCollapsed ? [(0, o.findAttributeRange)(i.getFirstPosition(), "linkHref", i.getAttribute("linkHref"), t)] : t.schema.getValidRanges(i.getRanges(), "linkHref");
          for (const t of s) if (e.removeAttribute("linkHref", t), n) for (const i of n.manualDecorators) e.removeAttribute(i.id, t);
        });
      }
    }
    class ce extends (0, r.ObservableMixin)() {
      constructor({
        id: e,
        label: t,
        attributes: i,
        ...
        super(), this.id = e, this.set("value", void 0), this.defaultValue = s, this.label = t, this.attributes = i, this.classes = n, this.styles = o;
      }
      _createPattern() {
        return {
    ...
    class me extends e.Plugin {
      ...
      static get requires() {
        return [o.TwoStepCaretMovement, o.Input, s.ClipboardPipeline];
      }
      constructor(e) {
      ...
      init() {
        ...
        }), e.commands.add("link", new se(e)), e.commands.add("unlink", new ae(e));
        const t = function (e, t) {
          const i = {
            "Open in a new tab": e("Open in a new tab"),
            Downloadable: e("Downloadable")
          };
          return t.forEach(e => ("label" in e && i[e.label] && (e.label = i[e.label]), e)), t;
        }(e.t, function (e) {
          const t = [];
          if (e) for (const [i, n] of Object.entries(e)) {
        ...
        this._enableAutomaticDecorators(t.filter(e => e.mode === he)), this._enableManualDecorators(t.filter(e => "manual" === e.mode));
        e.plugins.get(o.TwoStepCaretMovement).registerAttribute("linkHref"), (0, o.inlineHighlight)(e, "linkHref", "a", "ck-link_selected"), this._enableLinkOpen(), this._enableInsertContentSelectionAttributesFixer(), this._enableClickingAfterLink(), this._enableTypingOverLink(), this._handleDeleteContentAfterLink(), this._enableClipboardIntegration();
      }
      ...
      _enableManualDecorators(e) {
        ...
        e.forEach(e => {
          ...
          const n = new ce(e);
          i.add(n), t.conversion.for("downcast").attributeToElement({
            model: n.id,
            view: (e, {
              writer: t,
              schema: i
      ...
      _enableLinkOpen() {
        ...
        this.listenTo(t, "click", (e, t) => {
          if (!(r.env.isMac ? t.domEvent.metaKey : t.domEvent.ctrlKey)) return;
          let i = t.domTarget;
          if ("a" != i.tagName.toLowerCase() && (i = i.closest("a")), !i) return;
          const n = i.getAttribute("href");
          n && (e.stop(), t.preventDefault(), oe(n));
        }, {
          context: "$capture"
        }), this.listenTo(t, "keydown", (t, i) => {
          const n = e.commands.get("link").value;
          !!n && i.keyCode === r.keyCodes.enter && i.altKey && (t.stop(), oe(n));
        });
      }
      _enableInsertContentSelectionAttributesFixer() {
        ...
        this.listenTo(e, "insertContent", () => {
          ...
          t.hasAttribute("linkHref") && i && i.hasAttribute("linkHref") && (n && n.hasAttribute("linkHref") || e.change(t => {
            ge(t, pe(e.schema));
          }));
        }, {
          priority: "low"
      ...
      _enableClickingAfterLink() {
        ...
        this.listenTo(e.editing.view.document, "mousedown", () => {
          ...
          if (!n) return;
          n = !1;
          const e = i.document.selection;
          if (!e.isCollapsed) return;
          if (!e.hasAttribute("linkHref")) return;
          const t = e.getFirstPosition(),
            s = (0, o.findAttributeRange)(t, "linkHref", e.getAttribute("linkHref"), i);
          (t.isTouching(s.start) || t.isTouching(s.end)) && i.change(e => {
            ge(e, pe(i.schema));
          });
        });
      }
      _enableTypingOverLink() {
        ...
        this.listenTo(t.document, "delete", () => {
          ...
          t.isCollapsed || (n ? n = !1 : be(e) && function (e) {
            ...
            if (s === r) return !0;
            return (0, o.findAttributeRange)(i, "linkHref", s.getAttribute("linkHref"), e).containsRange(e.createRange(i, n), !0);
          }(e.model) && (i = t.getAttributes()));
        }, {
          priority: "high"
        }), this.listenTo(e.model, "insertContent", (t, [o]) => {
          n = !1, be(e) && i && (e.model.change(e => {
      ...
      _handleDeleteContentAfterLink() {
        ...
        this.listenTo(n.document, "delete", (e, t) => {
          ...
          s = r.containsPosition(e) || r.end.isEqual(e);
        }, {
          priority: "high"
        }), this.listenTo(t, "deleteContent", () => {
          r && (r = !1, s || e.model.enqueueChange(e => {
            ge(e, pe(t.schema));
          }));
        }, {
          priority: "low"
      ...
      _enableClipboardIntegration() {
        ...
        i && this.listenTo(e.plugins.get("ClipboardPipeline"), "contentInsertion", (e, n) => {
          t.change(e => {
            const t = e.createRangeIn(n.content);
            for (const n of t.getItems()) if (n.hasAttribute("linkHref")) {
              const t = ie(n.getAttribute("linkHref"), i);
    ...
    ue()(Ae.Z, xe);
    Ae.Z.locals;
    class Ie extends we.View {
      constructor(t, i) {
        super(t), this.focusTracker = new r.FocusTracker(), this.keystrokes = new r.KeystrokeHandler(), this._focusables = new we.ViewCollection();
        const n = t.t;
        this.urlInputView = this._createUrlInput(), this.saveButtonView = this._createButton(n("Save"), e.icons.check, "ck-button-save"), this.saveButtonView.type = "submit", this.cancelButtonView = this._createButton(n("Cancel"), e.icons.cancel, "ck-button-cancel", "cancel"), this._manualDecoratorSwitches = this._createManualDecoratorSwitches(i), this.children = this._createFormChildren(i.manualDecorators), this._focusCycler = new we.FocusCycler({
        ...
        i.manualDecorators.length && o.push("ck-link-form_layout-vertical", "ck-vertical-form"), this.setTemplate({
          tag: "form",
          attributes: {
            class: o,
            tabindex: "-1"
      ...
      render() {
        super.render(), (0, we.submitHandler)({
          view: this
        });
      ...
      _createUrlInput() {
        const e = this.locale.t,
          t = new we.LabeledFieldView(this.locale, we.createLabeledInputText);
        return t.label = e("Link URL"), t;
      }
      _createButton(e, t, i, n) {
        const o = new we.ButtonView(this.locale);
        return o.set({
          label: e,
          icon: t,
          tooltip: !0
      ...
      _createManualDecoratorSwitches(e) {
        ...
        for (const i of e.manualDecorators) {
          const n = new we.SwitchButtonView(this.locale);
          n.set({
            name: i.id,
            label: i.label,
            withText: !0
    ...
    class Te extends we.View {
      ...
      _createButton(e, t, i) {
        const n = new we.ButtonView(this.locale);
        return n.set({
          label: e,
          icon: t,
          tooltip: !0
      ...
      _createPreviewButton() {
        const e = new we.ButtonView(this.locale),
          t = this.bindTemplate,
          i = this.t;
        return e.set({
          withText: !0,
    ...
    const Ee = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="m11.077 15 .991-1.416a.75.75 0 1 1 1.229.86l-1.148 1.64a.748.748 0 0 1-.217.206 5.251 5.251 0 0 1-8.503-5.955.741.741 0 0 1 .12-.274l1.147-1.639a.75.75 0 1 1 1.228.86L4.933 10.7l.006.003a3.75 3.75 0 0 0 6.132 4.294l.006.004zm5.494-5.335a.748.748 0 0 1-.12.274l-1.147 1.639a.75.75 0 1 1-1.228-.86l.86-1.23a3.75 3.75 0 0 0-6.144-4.301l-.86 1.229a.75.75 0 0 1-1.229-.86l1.148-1.64a.748.748 0 0 1 .217-.206 5.251 5.251 0 0 1 8.503 5.955zm-4.563-2.532a.75.75 0 0 1 .184 1.045l-3.155 4.505a.75.75 0 1 1-1.229-.86l3.155-4.506a.75.75 0 0 1 1.045-.184z"/></svg>',
      Ce = "link-ui";
    class Le extends e.Plugin {
      ...
      init() {
        const e = this.editor;
        e.editing.view.addObserver(t.ClickObserver), this._balloon = e.plugins.get(we.ContextualBalloon), this._createToolbarLinkButton(), this._enableBalloonActivators(), e.conversion.for("editingDowncast").markerToHighlight({
          model: Ce,
          view: {
      ...
      _createFormView() {
        const e = this.editor,
          ...
          n = new ((0, we.CssTransitionDisablerMixin)(Ie))(e.locale, t);
        return n.urlInputView.fieldView.bind("value").to(t, "value"), n.urlInputView.bind("isEnabled").to(t, "isEnabled"), n.saveButtonView.bind("isEnabled").to(t), this.listenTo(n, "submit", () => {
          const {
              value: t
            } = n.urlInputView.fieldView.element,
            o = ie(t, i);
      ...
      _createToolbarLinkButton() {
        ...
        e.ui.componentFactory.add("link", e => {
          const n = new we.ButtonView(e);
          return n.isEnabled = !0, n.label = i("Link"), n.icon = Ee, n.keystroke = J, n.tooltip = !0, n.isToggleable = !0, n.bind("isEnabled").to(t, "isEnabled"), n.bind("isOn").to(t, "value", e => !!e), this.listenTo(n, "execute", () => this._showUI(!0)), n;
        });
      }
      ...
      _getBalloonPositionData() {
        ...
        let n;
        if (t.markers.has(Ce)) {
          const t = Array.from(this.editor.editing.mapper.markerNameToElements(Ce)),
      ...
      _getSelectedLinkElement() {
        const e = this.editor.editing.view,
          t = e.document.selection,
          i = t.getSelectedElement();
        if (t.isCollapsed || i && (0, ve.isWidget)(i)) return De(t.getFirstPosition());
        {
      ...
      _showFakeVisualSelection() {
        ...
        e.change(t => {
          ...
          if (e.markers.has(Ce)) t.updateMarker(Ce, {
            range: i
    ...
    const Me = new RegExp("(^|\\s)(((?:(?:(?:https?|ftp):)?\\/\\/)(?:\\S+(?::\\S*)?@)?(?:(?:[1-9]\\d?|1\\d\\d|2[01]\\d|22[0-3])(?:\\.(?:1?\\d{1,2}|2[0-4]\\d|25[0-5])){2}(?:\\.(?:[1-9]\\d?|1\\d\\d|2[0-4]\\d|25[0-4]))|(((?!www\\.)|(www\\.))(?![-_])(?:[-_a-z0-9\\u00a1-\\uffff]{1,63}\\.)+(?:[a-z\\u00a1-\\uffff]{2,63})))(?::\\d{2,5})?(?:[/?#]\\S*)?)|((www.|(\\S+@))((?![-_])(?:[-_a-z0-9\\u00a1-\\uffff]{1,63}\\.))+(?:[a-z\\u00a1-\\uffff]{2,63})))$", "i");
    class je extends e.Plugin {
      ...
      _enableTypingHandling() {
        const e = this.editor,
          t = new o.TextWatcher(e.model, e => {
            if (!function (e) {
              return e.length > 4 && " " === e[e.length - 1] && " " !== e[e.length - 2];
            }(e)) return;
            const t = Be(e.substr(0, e.length - 1));
            return t ? {
              url: t
            } : void 0;
          });
        ...
        const t = this.editor.model,
          {
            text: i,
            range: n
          } = (0, o.getLastTextLine)(e, t),
          s = Be(i);
        if (s) {
          const e = t.createRange(n.end.getShiftedBy(-s.length), n.end);
          this._applyAutoLink(s, e);
        }
      }
      _applyAutoLink(e, t) {
        const i = this.editor.model,
          n = ie(e, this.editor.config.get("link.defaultProtocol"));
    ...
    class He extends e.Plugin {
      static get requires() {
        return ["ImageEditing", "ImageUtils", me];
      }
      static get pluginName() {
        ...
        e.plugins.has("ImageBlockEditing") && t.extend("imageBlock", {
          ...
          return e => {
            e.on("element:a", (e, n, o) => {
              ...
              if (!l) return;
              let u = n.modelCursor.parent;
              if (!u.is("element", "imageBlock")) {
                const e = o.convertItem(r, n.modelCursor);
                n.modelRange = e.modelRange, n.modelCursor = e.modelCursor, u = n.modelCursor.nodeBefore;
              }
              u && u.is("element", "imageBlock") && o.writer.setAttribute("linkHref", l, u);
            }, {
              priority: "high"
            });
          };
        }(e)), e.conversion.for("downcast").add(function (e) {
          const t = e.plugins.get("ImageUtils");
          return e => {
            e.on("attribute:linkHref:imageBlock", (e, i, n) => {
              ...
              const o = n.mapper.toViewElement(i.item),
                ...
                c = a.parent.is("element", "picture") ? a.parent : a;
              if (r) i.attributeNewValue ? s.setAttribute("href", i.attributeNewValue, r) : (s.move(s.createRangeOn(c), s.createPositionAt(o, 0)), s.remove(r));else {
                const e = s.createContainerElement("a", {
                  href: i.attributeNewValue
                });
                s.insert(s.createPositionAt(o, 0), e), s.move(s.createRangeOn(c), s.createPositionAt(e, 0));
              }
            }, {
              priority: "high"
            });
          };
        }(e)), this._enableAutomaticDecorators(), this._enableManualDecorators();
      }
      _enableAutomaticDecorators() {
        const e = this.editor,
          t = e.commands.get("link").automaticDecorators;
        t.length && e.conversion.for("downcast").add(t.getDispatcherForLinkedImage());
      }
      _enableManualDecorators() {
        const e = this.editor,
          t = e.commands.get("link");
        for (const i of t.manualDecorators) e.plugins.has("ImageBlockEditing") && e.model.schema.extend("imageBlock", {
          allowAttributes: i.id
        }), e.plugins.has("ImageInlineEditing") && e.model.schema.extend("imageInline", {
          allowAttributes: i.id
        }), e.conversion.for("downcast").add(Oe(i)), e.conversion.for("upcast").add(Pe(e, i));
      }
    }
    function Oe(e) {
      return t => {
        t.on(`attribute:${e.id}:imageBlock`, (t, i, n) => {
          const o = n.mapper.toViewElement(i.item),
            s = Array.from(o.getChildren()).find(e => e.is("element", "a"));
          if (s) {
            for (const [t, i] of (0, r.toMap)(e.attributes)) n.writer.setAttribute(t, i, s);
            e.classes && n.writer.addClass(e.classes, s);
            for (const t in e.styles) n.writer.setStyle(t, e.styles[t], s);
          }
        });
      };
    }
    function Pe(e, i) {
      const n = e.plugins.has("ImageInlineEditing"),
        o = e.plugins.get("ImageUtils");
      return e => {
        e.on("element:a", (e, s, r) => {
          const a = s.viewItem,
            c = o.findViewImgElement(a);
          if (!c) return;
          const l = c.findAncestor(e => o.isBlockImageView(e));
          if (n && !l) return;
          const u = new t.Matcher(i._createPattern()).match(a);
          if (!u) return;
          if (!r.consumable.consume(a, u.match)) return;
          const d = s.modelCursor.nodeBefore || s.modelCursor.parent;
          r.writer.setAttribute(i.id, !0, d);
        }, {
          priority: "high"
        });
      };
    }
    class Ue extends e.Plugin {
      static get requires() {
        return [me, Le, "ImageBlockEditing"];
      }
      static get pluginName() {
        return "LinkImageUI";
      }
      init() {
        const e = this.editor,
          t = e.editing.view.document;
        this.listenTo(t, "click", (t, i) => {
          this._isSelectedLinkedImage(e.model.document.selection) && (i.preventDefault(), t.stop());
        }, {
          priority: "high"
      ...
      _createToolbarLinkImageButton() {
        ...
        e.ui.componentFactory.add("linkImage", i => {
          ...
          return n.set({
            ...
            tooltip: !0,
            isToggleable: !0
          }), n.bind("isEnabled").to(s, "isEnabled"), n.bind("isOn").to(s, "value", e => !!e), this.listenTo(n, "execute", () => {
