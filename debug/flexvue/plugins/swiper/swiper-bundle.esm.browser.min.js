...
var Virtual = {
    update: function (e) {
      ...
      var C = [],
        S = [];
      if (e) t.$wrapperEl.find("." + t.params.slideClass).remove();else for (var M = p; M <= u; M += 1) (M < y || M > x) && t.$wrapperEl.find("." + t.params.slideClass + '[data-swiper-slide-index="' + M + '"]').remove();
      for (var $ = 0; $ < c.length; $ += 1) $ >= y && $ <= x && (void 0 === u || e ? S.push($) : ($ > u && S.push($), $ < p && C.push($)));
