...
!function (e, t) {
      ...
      return function (e) {
        var t,
          ...
          F = Object.assign({}, V, {
            ...
            appendChildView: u(0, g),
            removeChildView: s(l, g),
  ...
  var ce,
    ...
    be = function (e, t) {
      return M(t) ? e[0] || null : F(t) ? e[t] || null : ("object" == typeof t && (t = t.id), e.find(function (e) {
        return e.id === t;
      }) || null);
    },
    Pe = function (e) {
    ...
    qe = function (e) {
      return {
        ...
        GET_PANEL_ASPECT_RATIO: function () {
          return /circle/.test(e.options.stylePanelLayout) ? 1 : Pe(e.options.stylePanelAspectRatio);
        },
      ...
      var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : null,
        ...
        f = Object.assign({
          ...
          process: function e(t, n) {
            if (i.processingAborted) i.processingAborted = !1;else if (s(Ie.PROCESSING), a = null, i.file instanceof Blob) {
      ...
      return {
        ...
        DID_UPDATE_ITEM_METADATA: function (t) {
          ...
          clearTimeout(r.itemUpdateTimeout), r.itemUpdateTimeout = setTimeout(function () {
            ...
            if (n("IS_ASYNC")) {
              ...
              return t.status === Ie.PROCESSING_COMPLETE ? (a = r.options.instantUpload, void t.revert(Et(r.options.server.url, r.options.server.revert), n("GET_FORCE_REVERT")).then(a ? u : function () {}).catch(function () {})) : t.status === Ie.PROCESSING ? function (e) {
                t.abortProcessing().then(e ? u : function () {});
              }(r.options.instantUpload) : void (r.options.instantUpload && u());
            }
            Oe("SHOULD_PREPARE_OUTPUT", !1, {
              ...
              i && (r = i(t, r)), r && e("REQUEST_PREPARE_OUTPUT", {
                query: o,
                item: t,
                success: function (t) {
        ...
        ADD_ITEM: function (t) {
          ...
          if (M(o)) f({
            ...
            r.options.itemInsertLocationFreedom || (a = "before" === m ? -1 : r.items.length), function (e, t, n) {
            ...
            }(o) && D ? at(R, D) : gt : at(R, I === ve.LIMBO ? y : O)), function (e, t, r) {
              Oe("LOAD_FILE", e, {
                query: n
              }).then(t).catch(r);
            });
        ...
        REMOVE_ITEM: At(r, function (t, o, i, a) {
          var u = function () {
              var n = t.id;
              ht(r.items, n).archive(), e("DID_REMOVE_ITEM", {
                error: null,
                id: n,
                item: t
              }), yt(e, r), o(Te(t));
            ...
            s = r.options.server;
          t.origin === ve.LOCAL && s && Y(s.remove) && !1 !== a.remove ? (e("DID_START_ITEM_REMOVE", {
            id: t.id
    ...
    Ht = S({
      ...
      create: function (e) {
        ...
        var r = Lt("span");
        r.className = "filepond--file-status-sub", t.appendChild(r), t.ref.sub = r, Yt({
          root: t,
          action: {
            progress: null
          }
  ...
  var zt,
    ...
    un = S({
      create: function (e) {
        ...
        if (s && i && (Xt.RevertItemProcessing.label = "GET_LABEL_BUTTON_REMOVE_ITEM", Xt.RevertItemProcessing.icon = "GET_ICON_REMOVE"), l && !i) {
          ...
          d.info.translateX = Kt, d.info.translateY = $t, d.status.translateY = $t, d.processingCompleteIndicator = {
            opacity: 1,
            scaleX: 1,
            scaleY: 1
          };
        }
        if (l && !u && (["DID_START_ITEM_PROCESSING", "DID_REQUEST_ITEM_PROCESSING", "DID_UPDATE_ITEM_PROCESS_PROGRESS", "DID_THROW_ITEM_PROCESSING_ERROR"].forEach(function (e) {
          rn[e].status.translateY = $t;
        }), rn.DID_THROW_ITEM_PROCESSING_ERROR.status.translateX = Zt), c && i) {
          Xt.RevertItemProcessing.align = "BUTTON_REMOVE_ITEM_POSITION";
          var p = rn.DID_COMPLETE_ITEM_PROCESSING;
          p.info.translateX = Qt, p.status.translateY = $t, p.processingCompleteIndicator = {
            opacity: 1,
            scaleX: 1,
            scaleY: 1
          };
        ...
        a || (Xt.RemoveItem.disabled = !0), t(Xt, function (e, t) {
          ...
          f.includes(e) && r.appendChildView(n), t.disabled && (n.element.setAttribute("disabled", "disabled"), n.element.setAttribute("hidden", "hidden")), n.element.dataset.align = r.query("GET_STYLE_" + t.align), n.element.classList.add(t.className), n.on("click", function (e) {
            e.stopPropagation(), t.disabled || r.dispatch(t.action, {
              query: o
            });
          }), r.ref["button" + e] = n;
        }), r.ref.processingCompleteIndicator = r.appendChildView(r.createChildView(on)), r.ref.processingCompleteIndicator.element.dataset.align = r.query("GET_STYLE_BUTTON_PROCESS_ITEM_POSITION"), r.ref.info = r.appendChildView(r.createChildView(Ft, {
          id: o
        })), r.ref.status = r.appendChildView(r.createChildView(Ht, {
          id: o
        }));
        ...
        var _ = r.appendChildView(r.createChildView(Nt, {
          opacity: 0,
    ...
    sn = S({
      create: function (e) {
        var t = e.root,
          n = e.props;
        t.ref.fileName = Lt("legend"), t.appendChild(t.ref.fileName), t.ref.file = t.appendChildView(t.createChildView(un, {
          id: n.id
        })), t.ref.data = !1;
      },
      ignoreRect: !0,
    ...
    _n = A({
      ...
      a ? o || (t.height = t.rect.element.width * a) : (En({
        root: t,
        actions: n,
        props: r
    ...
    Tn = S({
      create: function (e) {
        ...
        t.ref.handleClick = function (e) {
        ...
        }, t.element.id = "filepond--item-" + n.id, t.element.addEventListener("click", t.ref.handleClick), t.ref.container = t.appendChildView(t.createChildView(sn, {
          id: n.id
        })), t.ref.panel = t.appendChildView(t.createChildView(fn, {
          name: "item-panel"
          ...
          if (e.isPrimary) {
            ...
            var a,
              u,
              s,
              l = (a = t.query("GET_ACTIVE_ITEMS"), u = a.map(function (e) {
                return e.id;
              }), s = void 0, {
                setIndex: function (e) {
                  s = e;
    ...
    Rn = A({
      DID_ADD_ITEM: function (e) {
        ...
        t.ref.lastItemSpanwDate = u, t.appendChildView(t.createChildView(Tn, {
          spawnDate: u,
          id: r,
          opacity: s,
          interactionMethod: i
          ...
          var T = {
              ...
              getColIndex: function () {
                for (var e = t.query("GET_ACTIVE_ITEMS"), n = t.childViews.filter(function (e) {
                    ...
                    return e === a;
                  }), i = gn(a), u = r.length, s = u, l = 0, c = 0, d = 0, p = 0; p < u; p++) if (l = gn(r[p]), f < (c = (d = c) + l)) {
                  if (o > p) {
                    if (f < d + i) {
                      s = p;
                      break;
        ...
        if (0 !== s.length) {
          ...
          if (1 === m) {
            ...
            s.forEach(function (e, t) {
              ...
              o && (e.translateX = null, e.translateY = null), e.markedForRemoval || mn(e, 0, h + g);
    ...
    Nn = S({
      ...
      create: function (e) {
        var t = e.root,
          n = e.props;
        t.element.id = "filepond--browser-" + n.id, r(t.element, "name", t.query("GET_NAME")), r(t.element, "aria-controls", "filepond--assistant-" + n.id), r(t.element, "aria-labelledby", "filepond--drop-label-" + n.id), An({
          root: t,
          action: {
    ...
    qn = S({
      ...
      create: function (e) {
        ...
        }, o.addEventListener("keydown", t.ref.handleKeyDown), t.element.addEventListener("click", t.ref.handleClick), Bn(o, n.caption), t.appendChild(o), t.ref.label = o;
      },
      destroy: function (e) {
        var t = e.root;
    ...
    Fn = A({
      DID_DRAG: function (e) {
        ...
        t.ref.blob ? (t.ref.blob.translateX = n.position.scopeLeft, t.ref.blob.translateY = n.position.scopeTop, t.ref.blob.scaleX = 1, t.ref.blob.scaleY = 1, t.ref.blob.opacity = 1) : function (e) {
          ...
          t.ref.blob = t.appendChildView(t.createChildView(Vn, {
            opacity: 0,
            scaleX: 2.5,
            scaleY: 2.5,
            translateX: n,
      ...
      var i = {
        ...
        addListener: function (a) {
          return n.push(a), function () {
            n.splice(n.indexOf(a), 1), 0 === n.length && (cr.splice(cr.indexOf(i), 1), t(r, function (t) {
    ...
    Lr = function (e, t, n) {
      ...
      Pr(e, n + " " + t + ", " + r + " " + (1 === r ? e.query("GET_LABEL_FILE_COUNT_SINGULAR") : e.query("GET_LABEL_FILE_COUNT_PLURAL"))), clearTimeout(Ar), Ar = setTimeout(function () {
        !function (e) {
    ...
    Cr = function (e) {
      var t = e.root,
        n = e.action,
        r = t.query("GET_ITEM", n.id).filename;
      Pr(t, n.status.main + " " + r + " " + n.status.sub);
    },
    Nr = S({
      create: function (e) {
        var t = e.root,
        ...
        DID_LOAD_ITEM: function (e) {
          ...
          if (Mr(t)) {
            ...
            br.push(r.filename), clearTimeout(Sr), Sr = setTimeout(function () {
              Lr(t, br.join(", "), t.query("GET_LABEL_FILE_ADDED")), br.length = 0;
            }, 750);
          }
        },
        DID_REMOVE_ITEM: function (e) {
          ...
          if (Mr(t)) {
            var r = n.item;
            Lr(t, r.filename, t.query("GET_LABEL_FILE_REMOVED"));
          }
        },
        DID_COMPLETE_ITEM_PROCESSING: function (e) {
          var t = e.root,
    ...
    Wr = S({
      ...
      create: function (e) {
        ...
        }))), t.ref.list = t.appendChildView(t.createChildView(Dn, {
          translateY: null
        })), t.ref.panel = t.appendChildView(t.createChildView(fn, {
          name: "panel-root"
        })), t.ref.assistant = t.appendChildView(t.createChildView(Nr, Object.assign({}, n))), t.ref.data = t.appendChildView(t.createChildView(Xn, Object.assign({}, n))), t.ref.measure = Lt("div"), t.ref.measure.style.height = "100%", t.element.appendChild(t.ref.measure), t.ref.bounds = null, t.query("GET_STYLES").filter(function (e) {
          return !M(e.value);
        }).map(function (e) {
          var n = e.name,
            r = e.value;
      ...
      write: function (e) {
        ...
        if (Xr({
          ...
          if (s.translateY = Math.max(0, m - s.rect.element.marginTop) - T.top, c) {
            ...
            if (S.push(y), S.length > 4) for (var A = S.length, b = A - 10, P = 0, L = A; L >= b; L--) if (S[L] === S[L - 2] && P++, P >= 2) return;
      ...
      var p = Wr(i, {
        ...
        A = Object.assign({}, pe(), {}, I, {}, function (e, n) {
          ...
          restoreElement: function () {
            r && (P(r, p.element), p.element.parentNode.removeChild(p.element), r = null);
          },
        ...
        var n,
          r = e({
            ...
            utils: {
              ...
              applyFilterChain: Oe,
              text: Mt,
              getNumericAspectRatioFromString: Pe
            },
            views: {
              fileActionButton: Gt
            }
    ...
    uo = (zt = c() && !("[object OperaMini]" === Object.prototype.toString.call(window.operamini)) && "visibilityState" in document && "Promise" in window && "slice" in Blob.prototype && "URL" in window && "createObjectURL" in window.URL && "performance" in window && ("supports" in (window.CSS || {}) || /MSIE|Trident/.test(window.navigator.userAgent)), function () {
      return zt;
    }),
    so = {
      apps: []
  ...
  if (e.Status = {}, e.FileStatus = {}, e.FileOrigin = {}, e.OptionTypes = {}, e.create = lo, e.destroy = lo, e.parse = lo, e.find = lo, e.registerPlugin = lo, e.getOptions = lo, e.setOptions = lo, uo()) {
    ...
    e.Status = Object.assign({}, Me), e.FileOrigin = Object.assign({}, ve), e.FileStatus = Object.assign({}, Ie), e.OptionTypes = {}, fo(), e.create = function () {
      ...
      return H(n) && (so.apps.forEach(function (e) {
        e.setOptions(n);
      }), function (e) {
        t(e, function (e, t) {
