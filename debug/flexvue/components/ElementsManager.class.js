        ...
        for (let i = 0; i < this.target.length; i++) {
          if (value != null && value == this.target[i].value) {
            classNames.split(' ').forEach((cls) => {
              if (mode == 'add')
              this.target[i].classList.add(cls.trim());else
      ...
      } else
      {
        for (let i = 0; i < this.target.length; i++) {
          if (value != null && value == this.target[i].value) {
            classNames.split(' ').forEach((cls) => {
              if (mode == 'add')
              this.target[i].classList.add(classNames.trim());else
  ...
  classList(mode, classNames) {
    if (classNames.trim()) {
      ...
      if (hasWhitespace) {
        classNames.split(' ').forEach((cls) => {
          if (mode == 'add')
          this.target.classList.add(cls.trim());else
      ...
      {
        if (mode == 'add')
        this.target.classList.add(classNames.trim());else
